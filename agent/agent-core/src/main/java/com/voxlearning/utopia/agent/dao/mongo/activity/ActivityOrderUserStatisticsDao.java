...
@Named
@CacheBean(type =  ActivityOrderUserStatistics.class)
public class ActivityOrderUserStatisticsDao extends StaticCacheDimensionDocumentMongoDao<ActivityOrderUserStatistics, String> {

    @CacheMethod
    public ActivityOrderUserStatistics loadByUidAndDay(@CacheParameter("aid") String activityId, @CacheParameter("uid") Long userId, @CacheParameter("d") Integer day){
    ...
    public List<ActivityOrderUserStatistics> loadByUsersAndDays(String activityId, Collection<Long> userIds, Collection<Integer> days){
