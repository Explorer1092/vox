 ...
 *
 * @author chunlin.yu
 * @create 2017-11-07 11:08
 **/

@Getter
@Setter
public class TeacherPerformanceDetail implements Serializable{

    private static final long serialVersionUID = 1040352171186021207L;
    /**
     * 老师ID
     */
    ...
    /**
     * 所有学生当月完成1套当前科目作业学生数；=1，不限制当月是否达成了单科月活（20171130新增）
     */
    private int finCsHwEq1StuCount;

    /**
     * 所有学生当月完成2套当前科目作业学生数；=2，不限制当月是否达成了单科月活（20171130新增）
     */
