...
@Getter
@Setter
public class AgentSchoolKlxPerformanceIndicator implements Serializable {

    private int stuScale;                                          // 学生规模
    private int klxTnCount;                                          // 快乐学考号数

    private int tmFinBgExamGte6SubjStuCount;                         // 本月大考扫描6科以上学生数
    private int pdFinBgExamGte6SubjStuCount;                         // 昨日大考扫描6科以上学生数
    private int lmSubmitBgExamGte6SubjStuCount;                         // 上月大考扫描6科以上学生数（提报）
    private int pdLmSubmitBgExamGte6SubjStuCount;                         // 昨日上月大考扫描6科以上学生数（提报
    private int lmSubmitBgExamGte3SubjStuCount;                         // 上月大考扫描3科以上学生数（提报）
    private int pdLmSubmitBgExamGte3SubjStuCount;                         // 昨日上月大考扫描3科以上学生数（提报）

    private int tmFinBgExamStuCount;                                         // 本月大考扫描学生数
    private int pdFinBgExamStuCount;                                         // 昨日大考扫描学生数

    private int tmFinTpEq1StuCount;                                          // 本月作答1次试卷学生数
    ...
    private int tmFinTpEq2StuCount;                                          // 本月作答2次试卷学生数

    private int tmFinTpGte3StuCount;                                          // 本月作答3次及以上试卷学生数
    private int pdFinTpGte3StuCount;                                          // 昨日作答3次及以上试卷学生数

    private int tmScanTpMathTeaCount;                                          // 本月扫描试卷数学老师数
    private int tmScanTpEngTeaCount;                                          // 本月扫描试卷英语老师数
    private int tmScanTpPhyTeaCount;                                          // 本月扫描试卷物理老师数
    private int tmScanTpCheTeaCount;                                          // 本月扫描试卷化学老师数
    private int tmScanTpBiolTeaCount;                                          // 本月扫描试卷生物老师数
    private int tmScanTpChnTeaCount;                                          // 本月扫描试卷语文老师数
    private int tmScanTpHistTeaCount;                                          // 本月扫描试卷历史老师数
    private int tmScanTpGeogTeaCount;                                          // 本月扫描试卷地理老师数
    private int tmScanTpPolTeaCount;                                          // 本月扫描试卷政治老师数
