...
@Named
@CacheBean(type =  ActivityCouponStatistics.class)
public class ActivityCouponStatisticsDao extends StaticCacheDimensionDocumentMongoDao<ActivityCouponStatistics, String> {

    @CacheMethod
    public ActivityCouponStatistics loadByUidAndDay(@CacheParameter("aid") String activityId, @CacheParameter("uid") Long userId, @CacheParameter("d") Integer day){
    ...
    public List<ActivityCouponStatistics> loadByUsersAndDays(String activityId, Collection<Long> userIds, Collection<Integer> days){
