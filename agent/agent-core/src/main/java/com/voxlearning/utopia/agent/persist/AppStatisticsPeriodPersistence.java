 ...
 */
@Named
public class AppStatisticsPeriodPersistence extends AlpsStaticJdbcDao<AppStatisticsPeriod, Long> {
    @Override
    protected void calculateCacheDimensions(AppStatisticsPeriod document, Collection<String> dimensions) {
    }

    public List<AppStatisticsPeriod> loadByMonthAndAppKeys(List<String> appKeys, int startMonth, int endMonth) {
