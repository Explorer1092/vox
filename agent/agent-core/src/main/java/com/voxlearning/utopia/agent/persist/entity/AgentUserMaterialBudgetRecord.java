...
@DocumentCollection(collection = "agent_user_material_budget_record")
public class AgentUserMaterialBudgetRecord implements Serializable {
    private static final long serialVersionUID = 191746227193016827L;
