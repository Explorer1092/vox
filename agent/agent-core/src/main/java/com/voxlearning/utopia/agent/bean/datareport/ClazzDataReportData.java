...
@Setter
@NoArgsConstructor
public class ClazzDataReportData extends ReportData {
    ...
    public List<Object> getExportAbleData() {
        ...
        result.add(dataMap.get("clazzLevel"));
        result.add(dataMap.get("clazzName"));
        ...
        result.add(SafeConverter.toInt(dataMap.get("vacationHwFlag")) == 1 ? "是" : "否");
        return result;
    }
}
