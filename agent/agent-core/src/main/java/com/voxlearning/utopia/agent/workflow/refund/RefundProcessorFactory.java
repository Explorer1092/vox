 ...
 */
@Named
public class RefundProcessorFactory implements WorkFlowProcessorFactory {

    @Inject private RefundInitProcessor refundInitProcessor;
    @Inject private RefundFinancialProcessor refundFinancialProcessor;
    ...
    public WorkFlowProcessor getProcessor(WorkFlowContext context) {
        switch (AgentOrderStatus.of(context.getOrder().getOrderStatus())) {
            case INIT:
                return refundInitProcessor;
            case PENDING_FINANCIAL:
                return refundFinancialProcessor;
            default:
                return null;
        }
    }
