...
/**
 * 余额提现退款的初始化处理
 * Created by Yuechen.Wang on 2016/4/13
 */
@Named
public class CashWithdrawInitProcessor extends AbstractWorkFlowProcessor {

    @Inject private AgentOrderServiceClient agentOrderServiceClient;
    @Inject private BaseOrderService baseOrderService;
    @Inject private CashWithdrawNotifySender cashWithdrawNotifySender;
    ...
    public void agree(WorkFlowContext context) {
        ...
        agentOrderProcessHistory.setProcessNotes("新建余额提取申请");
        ...
        // 通知
        cashWithdrawNotifySender.initCashWithdrawNotify(agentOrder);
    }
