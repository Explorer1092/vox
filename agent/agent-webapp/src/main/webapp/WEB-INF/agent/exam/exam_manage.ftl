...
<@layout_default.page page_title='提报查询' page_num=15>
<style type="text/css">
            ...
            <div class="dataTables_wrapper" role="grid">
                <table class="table table-striped table-bordered bootstrap-datatable datatable dataTable "
                    ...
                    <tr>
                        ...
                        <th class="sorting" style="width: 100px;">科目数</th>
                    ...
                    for(var i=0;i < res.dataList.length;i++){
                            ...
                            if (subjectList){
                                for(var j = 0; j < subjectList.length ;j++){
                                    ...
                                    var operator = "<span class='show_exam_info' style='cursor:pointer;color:blue;' data-gradedes='" + subject.gradeDes + "' data-schoolname='" + item.schoolName + "' data-detail='" + JSON.stringify(subject.agentGradeDetails) + "'>扫描统计</span>";
                                    item.createDatetime = new Date(item.createDatetime).Format('yyyy-MM-dd');
                                    arr = [item.createDatetime, item.cityName, item.schoolId, item.schoolName, item.ownerName, subject.gradeDes,subject.subjectCount+'科',subject.bgExamGte3StuCount+'人',subject.bgExamGte6StuCount+'人', operator];
