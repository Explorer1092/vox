...
<@layout_default.page page_title='我的账户' page_num=18>
            ...
            <form class="form-horizontal">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <label class="control-label">
                                <input class="messageTypes" type="checkbox" name="messageTypes" value="1" />发送Push
                            </label>
                            <label class="control-label">
                                <input class="messageTypes" type="checkbox" name="messageTypes" value="2" />发送系统消息
                            </label>
                        </div>
                    </div>
                    <fieldset class="fieldset_1" style="display: none;">
                        <div class="control-group">
                            <label class="control-label">Push消息</label>
                            <div class="controls">
                                <label class="control-label">
                                    <textarea name="pushContent" id="pushContent" cols="30" rows="10" maxlength="99" placeholder="最多输入99字"></textarea>
                                </label>
                            </div>
                        </div>
                        <div class="control-group">
                                ...
                                <label class="control-label">
                                    <select name="expireTime" id="expireTime">
                                        ...
                                        <#list type_list as list>
                                            <option value="${list}">${list}天</option>
                                        </#list>
                                    </select>
                                </label>
                            </div>
                        ...
                        <div class="control-group schoolPopularity">
                            ...
                            <div class="controls">
                                <label style="text-align: left;float: left;padding-right: 20px;top: 50px;padding-top: 5px;">
                                    <input type="text" id="notifyTitle" name="notifyTitle" value="" maxlength="8"/>
                                </label>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea class="input-xlarge" id="notifyContent" rows="5" style="width: 880px;" maxlength="60" placeholder="最多输入60字"></textarea>
                            </div>
                        </div>
                        <div class="control-group">
                    ...
                    <div class="control-group noedit-item">
                        ...
                        <div class="controls">
                            <input class="sendRange" name="sendRange" type="radio" value="1" checked>指定部门
                            <input class="sendRange" name="sendRange" type="radio" value="2">指定用户
                        </div>
                    </div>
                    <fieldset>
                        <fieldset class="group_user_1">
                            <div class="control-group noedit-item">
                            ...
                            <div class="control-group noedit-item">
                                ...
                                <div class="controls">
                                    <#if others?? && others?size gt 0>
                                        <input type="checkbox"  name ="roleType" value=" <#list others as list>${list.id!0}<#if list_has_next>,</#if></#list>"> 其他
                                    </#if>
                                </div>
                            </div>
                        </fieldset>
                        <fieldset class="group_user_2" style="display: none;">
                            <div class="control-group">
                                <label class="control-label">用户ID</label>
                                <div class="controls">
                                    <label class="control-label">
                                        <textarea name="" id="userId" cols="30" rows="10" placeholder="回车分隔"></textarea>
                                    </label>
                                </div>
                            </div>
                        </fieldset>
...
//                                save(postData,$this);
    ...
    $('input[name="roleType"]').on('click',function () {
    ...
    $(function(){
        ...
        $('#submitBtn').live('click',function(){
            var postData = {};
            var messageTypes = [];
            for(var i = 0 ;i < $('input[name="messageTypes"]:checked').length;i++){
                messageTypes.push($('input[name="messageTypes"]:checked').eq(i).val())
            }
            postData.messageTypes = messageTypes.toString();
            var _push = messageTypes.indexOf('1') > -1 ;
            var _system = messageTypes.indexOf('2') > -1 ;
            if(!_push && !_system){
                alert("请选择消息类型");
                return;
            }
            ...
            $.get('/message/manage/saveData.vpage',postData,function(data){
                if(!data.success){
                    ...
                    if(confirm("提交成功") == true){
                        window.location.href="message_list.vpage";
                    }
                }
            });
        });
