...
<head>
    ...
    <script src="/public/js/handerbars/handlebars-v4.0.5.js"></script>
</head>
<body>
<div role="main">
    <#nested />
...
<div class="mobileCRM-V2-footer" <#if (group?? && group == "login")>style="display: none" </#if>>
    <div class="inner">
        <div><a href="/mobile/performance/index.vpage" class="${((group == "业绩")?string("active", ""))!''}">业绩</a></div>
        <div><a href="/mobile/resource/school/list.vpage" class="${((group == "搜索")?string("active", ""))!''}">资源</a></div>
