...
<div class="mobileCRM-V2-header">
    <div class="inner">
        <div class="box">
            <a href="/mobile/school/school_info.vpage?schoolId=${schoolId!}" class="headerBack">&lt;&nbsp;返回</a>
...
<div class="mobileCRM-V2-tab">
    <div <#if type == 1>class="active"</#if>>
        <a href="/mobile/school/statistics_grade.vpage?schoolId=${schoolId}&type=1">使用</a>
    </div>
    <div <#if type == 2>class="active"</#if>>
        <a href="/mobile/school/statistics_grade.vpage?schoolId=${schoolId}&type=2">认证</a>
    </div>
    <div <#if type == 3>class="active"</#if>>
        <a href="/mobile/school/statistics_grade.vpage?schoolId=${schoolId}&type=3">本月高覆盖</a>
    </div>
    <div <#if type == 4>class="active"</#if>>
        <a href="/mobile/school/statistics_grade.vpage?schoolId=${schoolId}&type=4">双科认证</a>
    </div>
</div>
<ul class="mobileCRM-V2-list">
    ...
    <#if list??>
        <#list list as item>
            <li>
                <a href="/mobile/school/statistics_clazz.vpage?schoolId=${schoolId}&clazzLevel=${item.clazzLevel}&type=${type}" class="link link-ico">
