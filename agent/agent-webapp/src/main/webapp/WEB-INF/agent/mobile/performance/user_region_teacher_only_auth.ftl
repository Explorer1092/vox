...
<ul class="mobileCRM-V2-list">
    <#if  regionPerformance?has_content>
        ...
        <#list regionPerformance as performance>
            ...
            <#if performance.type == "REGION" || addTeaAuthNum gt 0>
                <#assign totalTeaAuthNum = totalTeaAuthNum + addTeaAuthNum>
                <li>
                    <#if performance.type != "SCHOOL">
                    <a href="/mobile/performance/user_region_teacher_only_auth.vpage?startDate=${startDate!''}&endDate=${endDate!''}&regionCode=${performance.key!''}" class="link link-ico">
                    <#else>
                    <a href="/mobile/performance/school_auth_teacher.vpage?startDate=${startDate!''}&endDate=${endDate!''}&schoolId=${performance.key!''}" class="link link-ico">
                    </#if>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#select-ok").click(function () {
            ...
            window.location.href = "/mobile/performance/user_region_teacher_only_auth.vpage?startDate=" + startDate + "&endDate=" + endDate + "&regionCode=${regionCode!''}";
        });
    });
</script>
</@layout.page>
