...
<div class="mobileCRM-V2-tab">
    <div class="active" onclick="changeTab(this, 'doubleSubject')">双科认证</div>
    ...
    <#if studentMap??>
    <ul class="mobileCRM-V2-list" id="doubleSubject" >
        <li>
            <div class="box link-ico">
                <div class="side-fl side-time">姓名</div>
                <div class="side-fr side-time side-width" style="width: 30%;">高质量日期</div>
            </div>
        </li>
        <#if studentMap["4"]??>
            <#assign studentList = studentMap["4"]>
    ...
    <ul class="mobileCRM-V2-list" id="noneHomework" style="display: none">
        <li>
            <div class="box link-ico">
                <div class="side-fl side-time">姓名</div>
                <div class="side-fr side-time side-width" style="width: 30%;">认证日期</div>
            </div>
        </li>
        <#if studentMap["7"]??>
