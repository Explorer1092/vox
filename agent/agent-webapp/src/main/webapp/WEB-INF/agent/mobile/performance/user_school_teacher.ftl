        ...
        <#list regionPerformance as performance>
            ...
            <#if performance.type == "REGION" || addTeaAuthNum gt 0 || addTeaRegNum gt 0>
                <li>
                    ...
                    <a href="/mobile/performance/user_school_teacher.vpage?startDate=${startDate!''}&endDate=${endDate!''}&regionCode=${performance.key!''}" class="link link-ico">
                    <#else>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#select-ok").click(function () {
            ...
            window.location.href = "/mobile/performance/user_school_teacher.vpage?startDate=" + startDate + "&endDate=" + endDate + "&regionCode=${regionCode!''}";
        });
    });
</script>
</@layout.page>