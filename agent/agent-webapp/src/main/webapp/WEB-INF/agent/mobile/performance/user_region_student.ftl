        ...
        <#list regionPerformance as performance>
            ...
            <#if performance.type == "REGION" || addStuRegNum gt 0>
                ...
                <li>
                    ...
                    <a href="/mobile/performance/user_region_student.vpage?startDate=${startDate!''}&endDate=${endDate!''}&regionCode=${performance.key!''}" class="link link-ico">
                    <#else>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#select-ok").click(function () {
            ...
            window.location.href = "/mobile/performance/user_region_student.vpage?startDate=" + startDate + "&endDate=" + endDate + "&regionCode=${regionCode!''}";
        });
    });
</script>
</@layout.page>