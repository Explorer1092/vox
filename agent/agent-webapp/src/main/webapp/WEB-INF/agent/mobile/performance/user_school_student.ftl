...
<div class="mobileCRM-V2-header">
    <div class="inner">
        <div class="box">
            ...
            <a href="/mobile/performance/user_region_student.vpage" class="headerBtn">我的区域</a>
        </div>
    </div>
</div>
        ...
        <#list regionPerformance as performance>
            ...
            <#if performance.type == "REGION" || addStuRegNum gt 0>
                <li>
                    ...
                    <a href="/mobile/performance/user_school_student.vpage?startDate=${startDate!''}&endDate=${endDate!''}&regionCode=${performance.key!''}" class="link link-ico">
                    <#else>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#select-ok").click(function () {
            ...
            window.location.href = "/mobile/performance/user_school_student.vpage?startDate=" + startDate + "&endDate=" + endDate + "&regionCode=${regionCode!''}";
        });
    });
</script>
</@layout.page>