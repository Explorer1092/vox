...
<div class="row-fluid sortable ui-sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form id="query_form"  action="downloadworkrecord.vpage" method="post" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="control-group span5">
                        <label class="control-label" for="selectError3">请选择数据类型：</label>
                        <input type="radio" name="workRecordType" checked value="SCHOOL" id="SCHOOL" style="margin-left: 1px;">进校
                        <input type="radio" name="workRecordType" value="MEETING" id="MEETING" style="margin-left: 1px;">组会
                        <input type="radio" name="workRecordType" value="VISIT" id="VISIT" style="margin-left: 1px;">陪访
                        <input type="radio" name="workRecordType" value="TEACHING" id="TEACHING" style="margin-left: 1px;">拜访教研员
                    </div>
                    <div class="control-group span3">
                        <div class="controls">
