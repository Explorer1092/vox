...
<@layout_default.page page_title='注册老师' page_num=1>
<div class="row-fluid sortable ui-sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title="">
            <h2><i class="icon-zoom-in"></i> 注册老师信息</h2>
            ...
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper" role="grid">
                <table class="table table-striped table-bordered bootstrap-datatable" id="dt_kpi_detail">
                    ...
                    <tr>
                        ...
                        <th class="sorting" style="width: 100px;">注册时间</th>
                    </tr>
                    </thead>
                    <tbody>
                        <#if teachers?has_content>
                            ...
                            <tr class="odd">
                                ...
                                <td class="center  sorting_1">${teacher["regtime"]!}</td>
                            </tr>
                            </#list>
                        </#if>
                    </tbody>
