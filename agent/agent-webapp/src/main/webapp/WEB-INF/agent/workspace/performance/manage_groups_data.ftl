...
<div class="row-fluid sortable ui-sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            <form id="query_form"  action="manage_groups_data.vpage" method="get" class="form-horizontal">
                <fieldset>
            ...
            <div id="topRegisterDataTab" class="dataTables_wrapper">
                <table class="table table-striped table-bordered bootstrap-datatable datatable dataTable">
                    ...
                    <tr>
                        ...
                        <th class="sorting" style="width: 10%;">部门类别</th>
                        ...
                        <#if dataList??>
                            <#list dataList as item>
                                <tr class="odd tbody01">
                                    ...
                                    <td class="center  sorting_1"><#if item.groupRoleType??>${item.groupRoleType.roleName!}</#if></td>
...
<script type="text/javascript">
    ...
    function downloadData(){
        var month = $("#month").val();
        window.location.href = "downloadperformance.vpage?type=3&month=" + month;
    }
</script>
</@layout_default.page>
