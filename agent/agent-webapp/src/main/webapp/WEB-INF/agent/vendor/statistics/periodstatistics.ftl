...
<@layout_default.page page_title='应用按周期月度统计' page_num=7>

<div class="row-fluid sortable ui-sortable">
    <div class="box span12">
        <div class="box-header well" data-original-title="">
            <h2><i class="icon-search"></i> 应用按周期月度统计</h2>
            <div class="box-icon">
        ...
        <div class="box-content">
            <form id="query_form"  action="periodstatistics.vpage" method="get" class="form-horizontal">
                <fieldset>
            ...
            <div id="topRegisterDataTab" class="dataTables_wrapper">
                <table class="table table-striped table-bordered bootstrap-datatable datatable dataTable">
                    ...
                    <tr>
                        ...
                        <th class="sorting" style="width: 100px;">周期</th>
                        ...
                        <th class="sorting" style="width: 100px;">购买人数</th>
                    </tr>
                    </thead>
                    <tbody>
                        <#if monthList??>
                            ...
                            <tr class="odd">
                                ...
                                <td class="center  sorting_1">${month.appPeriod!}天</td>
                                <td class="center  sorting_1">${month.totalRevenue!}</td>
                                <td class="center  sorting_1">${month.refundAmount!}</td>
                                <td class="center  sorting_1">${month.orderCount!}</td>
                                <td class="center  sorting_1">${month.paidUserCount!}</td>
                            </tr>
                            </#list>
                        </#if>
                    </tbody>
