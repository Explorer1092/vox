            ...
            <div class="box-content">
                <div class="form-horizontal">
                    ...
                    <fieldset>
                        ...
                        <div class="flieContainer" <#if plan.paperType?? &&  plan.paperType== "OLD"> style="display: none;" </#if> >
                            <div class="control-group" id="sourceExcelFile_div">
                                ...
                                <#if plan.paperDocUrls?has_content>
                                    <#assign paperDocName = plan.paperDocNames?split(",") />
                                    <#list plan.paperDocUrls?split(",") as address>
                                        <div class="controls">
                                            <a id = "paperDocUrls_a" class="paperDocUrls_a" href="${address!}" download="${paperDocName[address_index]!}">点击下载查看详情</a>
                                        </div>
                                    </#list>
                                </#if>
                            </div>
                        ...
                        <#if (plan.status!'') == 'EXAM_PUBLISHED' || (plan.status!'') == 'EXAM_OFFLINE'>
                            <div class="control-group">
                        ...
                        <#if (plan.pattern!'') == 'REGISTER'>
                            <div class="control-group" disabled="true">
                                <div style="display: inline-block">
                                    <label class="control-label">报名截止时间:</label>
                                    <div class="controls">
                                    ${plan.registrationDeadlineTime?string('yyyy-MM-dd HH:mm:ss')}
                                    </div>
                                </div>
                            </div>
                        </#if>
                            ...
                            <div id = "spokenAnswerTimes_div" class="control-group">
                                ...
                                <#if spokenTimes?has_content && spokenTimes?size gt 0>
                                    <#list spokenTimes as i>
                                        <#if (plan.spokenAnswerTimes!'') == i.key>${i.value}</#if>
                                    </#list>
                                </#if>
                                </div>
                            </div>
