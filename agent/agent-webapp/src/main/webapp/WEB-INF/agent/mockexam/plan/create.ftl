...
<@layout_default.page page_title='测评申请' page_num=3>
            ...
            <div class="form-horizontal">
                ...
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="name" name ="name" placeholder="不超过50中文…">
                        </div>
                    </div>
                    <div class="control-group">
                        <div style="display: inline-block">
                            ...
                            <div class="controls">
                                <#list subject as i>
                                    <input class="subject" type="radio"  name ="subject" value="${i.key}" <#if (plan.subject!'') == (i.key!'')>checked</#if>> ${i.value}
                                </#list>
                            </div>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <#list type as i>
                                <span class="testType">
                                    <input class="type" type="checkbox"  name ="type" value="${i.key}" <#if plan.type??><#list plan.type?split(",") as item><#if item == (i.key!"")>checked</#if></#list></#if>> ${i.value}
                                </span>
                            </#list>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div id="junior_div">
                                <#list grade as i>
                                    <input type="radio"  name ="grade" value="${i.key}"> ${i.value}
                                </#list>
                            </div>
                        </div>
                    </div>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <#list form as i>
                                <input type="radio"  name ="form" value="${i.key}" <#if (plan.form!'') == (i.key!'')>checked</#if>> ${i.value}
                            </#list>
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select id = "paperType" >
                                <#list paperType as i>
                                    <option name ="paperType" value="${i.key}" <#if plan.paperType?? && plan.paperType == (i.key!'')>selected</#if>> ${i.value}</option>
                                </#list>
                            </select>
                        </div>
                    </div>
                    <div class="flieContainer">
                        <div class="control-group" id="sourceExcelFile_div" <#if plan.paperType?? && plan.paperType == "OLD">style="display: none;"</#if> >
                            <label class="control-label">上传文档</label>
                            <div class="controls">
                                ...
                                <a  id = "paperDocUrls_a" class="paperDocUrls_a" href="${paperDocUrls!}" style="display: none;">点击下载查看详情</a>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <#list distributeType as i>
                                <input type="radio"  name ="distributeType" value="${i.key}" <#if plan.distributeType == i.key>checked</#if>> ${i.value}
                            </#list>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <#list scene as i>
                                <input type="radio"  name ="scene" value="${i.key}" <#if plan.scene?? && plan.scene == (i.key!'')>checked</#if>> ${i.value}
                            </#list>
                            <span style="color:red">（在机房集中考试，需要现场部署考试机，官网上没有考试卡片，需要在机房里集中考试）</span>
                        </div>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <#list regionLevel as i>
                                <input type="radio"  name ="regionLevel" value="${i.key}" <#if plan.regionLevel == (i.key!"")>checked</#if>> ${i.value}
                            </#list>
                        </div>
                    </div>
                            ...
                            <select id ="provinceCode">
                                ...
                                <#if provinces??>
                                    <#list provinces as provinceInfo>
                                        <option name="provinceName" value = "${provinceInfo.id}" >${provinceInfo.name}</option>
                                    </#list>
                                </#if>
                            </select>
                        </div>
                    ...
                    <div class="control-group">
                        <div style="display: inline-block">
                            ...
                            <div class="controls">
                                <input type="text" id="startTime" name ="startTime" class="apply_input_time" <#if plan.startTime??>value ="${plan.startTime?string('yyyy-MM-dd')}"</#if>>
                                <select class="s_time" name="unifiedExamBeginTimeHour" id="unifiedExamBeginTimeHour">
                                    <#if plan.startTime??>
                                        <@forOption start=0 end=23 defaultVal=plan.startTime?string("HH")?number />
                                    <#else>
                                ...
                                <select class="s_time" name="unifiedExamBeginTimeMin" id="unifiedExamBeginTimeMin">
                                    <#if plan.startTime??>
                                        <@forOption start=0 end=59 defaultVal= plan.startTime?string('mm')?number />
                                    <#else>
                        ...
                        <div style="display: inline-block">
                            ...
                            <div class="controls">
                                <input type="text" id="endTime" name ="endTime" class="apply_input_time" <#if plan.endTime??>value = "${plan.endTime?string('yyyy-MM-dd')}"</#if>>
                                <select class="s_time" name="unifiedExamEndTimeHour" id="unifiedExamEndTimeHour">
                                    <#if plan.endTime??>
                                        <@forOption start=0 end=23 defaultVal= plan.endTime?string('HH')?number />
                                    <#else>
                                        <@forOption start=0 end=23 defaultVal=0 />
                                    </#if>
                                </select> 时
                                <select class="s_time" name="unifiedExamEndTimeMin" id="unifiedExamEndTimeMin">
                                    <#if plan.endTime??>
                                        <@forOption start=0 end=59 defaultVal= plan.endTime?string('mm')?number />
                                    <#else>
                                        <@forOption start=0 end=59 defaultVal= 0 />
                                    </#if>
                                </select> 分
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="teacherMarkDeadline" name ="teacherMarkDeadline" class="apply_input_time" <#if plan.teacherMarkDeadline??>value = "${plan.teacherMarkDeadline?string('yyyy-MM-dd')}"</#if>>
                            <select class="s_time" name="correctingTestPaperHour" id="correctingTestPaperHour">
                                <#if plan.teacherMarkDeadline??>
                                    <@forOption start=0 end=23 defaultVal= plan.teacherMarkDeadline?string('HH')?number />
                                <#else>
                                    <@forOption start=0 end=23 defaultVal=0 />
                                </#if>
                            </select> 时
                            <select class="s_time" name="correctingTestPaperMin" id="correctingTestPaperMin">
                                <#if plan.teacherMarkDeadline??>
                                    <@forOption start=0 end=59 defaultVal= plan.teacherMarkDeadline?string('mm')?number />
                                <#else>
                                    <@forOption start=0 end=59 defaultVal= 0 />
                                </#if>
                            </select> 分
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="scorePublishTime" name ="scorePublishTime" class="apply_input_time" <#if plan.scorePublishTime??>value = "${plan.scorePublishTime?string('yyyy-MM-dd')}"</#if>>
                            <select class="s_time" name="achievementReleaseTimeHour" id="achievementReleaseTimeHour">
                                <#if plan.scorePublishTime??>
                                    <@forOption start=0 end=23 defaultVal= plan.scorePublishTime?string('HH')?number />
                                <#else>
                                    <@forOption start=0 end=23 defaultVal=0 />
                                </#if>
                            </select> 时
                            <select class="s_time" name="achievementReleaseTimeMin" id="achievementReleaseTimeMin">
                                <#if plan.scorePublishTime??>
                                    <@forOption start=0 end=59 defaultVal= plan.scorePublishTime?string('mm')?number />
                                <#else>
                                    <@forOption start=0 end=59 defaultVal= 0 />
                                </#if>
                            </select> 分
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="number" id="finishExamTime" name ="finishExamTime" value="${plan.finishExamTime!3}">分钟之后（0分钟代表可以任何时候交卷）
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">试卷总答题时长</label>
                        <div class="controls">
                            <input type="number" id="examTotalTime" name ="examTotalTime" value="${plan.examTotalTime!10}"> 分钟
                        </div>
                    </div>
                    <div class="control-group" id="spokenScoreType">
                        ...
                        <div class="controls">
                            <#list spokenScoreType as i>
                                <input type="radio"  name ="spokenScoreType" value="${i.key}" <#if plan.spokenScoreType?? && plan.spokenScoreType == i.key>checked</#if>> ${i.value}
                            </#list>
                        </div>
                    </div>
                    <div id="spokenAnswerTimes_div" class="control-group">
                    ...
                    <#--<div class="control-group">-->
                        ...
                        <#--<div class="controls">-->
                            <#--<input type="number" id="totalScore" name ="totalScore" min="0"> 分-->
                        <#--</div>-->
                    <#--</div>-->
...
<script type="text/html" id="books">
    ...
    <option name="bookCatalogId" value = "<%=res[i].id%>" <%if(res[i].name == "${plan.bookName!''}"){%>selected<%}%> ><%=res[i].name%></option>
    <%}%>
</script>
<script type="text/javascript">
    var codeList = [];
    <#if plan.regionCodes??>
        codeList = "${plan.regionCodes!''}".split(",");
    </#if>
    var nameList = [];
    <#if plan.regionNames??>
        nameList = "${plan.regionNames!''}".split(",");
    </#if>
    var codeObj = {};
    ...
    $(function(){
        $('#unifiedExamEndTimeHour').on("change",function () {
//            $('#correctingTestPaperHour').val($('#unifiedExamEndTimeHour').val())
            for(var i = 0;i<$('#correctingTestPaperHour option').length;i++){
                if($('#correctingTestPaperHour option').eq(i).val() == $(this).val()){
                    $('#correctingTestPaperHour option').eq(i).attr('selected',true);
                }else{
                    $('#correctingTestPaperHour option').eq(i).attr('selected',false);
                }
            }
        });
        $('#unifiedExamEndTimeMin').on("change",function () {
//            $('#correctingTestPaperHour').val($('#unifiedExamEndTimeHour').val())
            for(var i = 0;i<$('#correctingTestPaperMin option').length;i++){
                if($('#correctingTestPaperMin option').eq(i).val() == $(this).val()){
                    $('#correctingTestPaperMin option').eq(i).attr('selected',true);
                }else{
                    $('#correctingTestPaperMin option').eq(i).attr('selected',false);
                }
            }
        });
        ...
        function showSignUpLimitTime(){//管理员角色 显示隐藏考试截止时间
    ...
    $("#endTime").datepicker({
        ...
        onSelect : function (selectedDate){
            var _startTime =  $("#startTime").val();
            $("#teacherMarkDeadline").val(selectedDate);
            if(_startTime ){
    ...
    $("#registrationDeadlineTime").datepicker({
        ...
        onSelect : function (selectedDate){
            ...
            var startTime = new Date(_startTime.replace(/-/g,"/")).getTime() + $("#unifiedExamBeginTimeHour").val() * 60 * 60 * 1000;
            var $selectedDate = new Date(selectedDate.replace(/-/g,"/")).getTime() + $("#registrationDeadlineHour").val() * 60 * 60 * 1000;
            if($selectedDate > startTime - 1000 * 60 * 60) {
                alert("报名截止时间必须在考试开始一个小时之前");
...
//            $('.allowTeacherModify').show();
    ...
    function data_info(url){
        ...
        var arr = [];
        var arr1 = [];
        if($(".paperDocUrls").length > 1 && $("input[name='subject']:checked").val() == 'MATH'){
            alert('数学科目只允许上传1个文档');
            return false;
        }
...
//        var _totalScore =$.trim($("#totalScore").val());
//        if(!_totalScore || _totalScore == '' || !regular_num.test(_totalScore)){
//            alert("请填写有效的总分数");
//            return false;
//        }
...
//        unifiedExamApply.totalScore  = _totalScore;
    ...
    $("#add_school_submit_btn").on("click",function(){
        ...
        if($schoolIds){
            for(var ii = 0 ; ii < $schoolIds.length ; ii++ ){
                ...
                if(_schoolIds.indexOf(id.toString()) == -1){
                    _schoolIds.push(id);
...
//            $("#schoolinfo_tbody").empty();
    ...
    $(document).on("click",".delete_data",function () {
        ...
        _schoolIds.splice(_schoolIds.indexOf(id.toString()),1)
            ...
            new ss.SimpleUpload({
                ...
                onComplete: function (filename, response) {
                    ...
                    $dom
                            ...
                            .next().val(filename.split('.')[0])   // input hidden
