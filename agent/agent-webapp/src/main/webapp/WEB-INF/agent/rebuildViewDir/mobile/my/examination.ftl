...
<@layout.page title="统考测评申请" pageJs="workflow" footerIndex=4>
                            ...
                            <div class="c-list">
                                <#list data as item>
                                    <div class="adjustmentExamine-box" style="margin-top: .5rem">
                                        <div class="adjust-head js-itemBtn" data-sid="${item.apply.id!0}" style="border:none" data-type="AGENT_UNIFIED_EXAM_APPLY">
                                            <div class="right">${item.apply.createDatetime?string("MM-dd")}</div>
                                            <div>统考测评</div>
                                            <div class="">${item.apply.unifiedExamName!""}</div>
