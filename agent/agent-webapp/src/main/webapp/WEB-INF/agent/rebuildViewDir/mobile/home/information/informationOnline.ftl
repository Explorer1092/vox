...
<div class="primary-box">
    ...
    <div class="apply_nav" style="display:none;z-index:100;position:fixed;background-color:rgba(125,125,125,.5);width:100%;height:100%">
        <ul class="nav_2 Infiltration" style="top:0">
            <li class="chooseGroupCode active" data-info="1">全部中学</li>
        ...
        <div class="schoolRecord-box view-box">
            <div class="srd-module">
                <ul class="srd-nav">
                    ...
                    <li class="tab_li" style="width:25%" data-index="<%=key%>"><%=resKey.viewName%></li>
                    <%}%>
                </ul>
                <div class="mTable">
                    <%for (var key in dataMap){%>
                    ...
                    <table class="table_<%=key%>" cellpadding="0" cellspacing="0" style="display:none;">
                        ...
                        <tr>
                            <td class="sortable" style="display: none;"></td>
                            <td class="sortable">部门/姓名</td>
                            <td class="sortable">月活</td>
                            <td class="sortable">新增</td>
                            <td class="sortable">回流</td>
                            <td class="sortable">次月留存</td>
                        </tr>
                        </thead>
                        <tbody>
                        <%for(var j=0;j< resKey.length;j++){%>
                        ...
                        <tr class="js-item" data-id="<%=resList.id%>" data-type="<%=resList.idType%>" data-level="<%=resList.schoolLevel%>">
                            ...
                            <td class="3"><%=resList.engIncMauc%></td>
                            <td class="4"><%=resList.engBfMauc%></td>
                            <td class="5"><%=Math.round(resList.engMrtRate *100)%>%</td>
                        </tr>
                        <%}%>
                        </tbody>
                    </table>
                    ...
                    <table class="table_<%=key%>" cellpadding="0" cellspacing="0" style="display:none;">
                        ...
                        <tr>
                            <td class="sortable" style="display: none;"></td>
                            <td class="sortable">部门/姓名</td>
                            <td class="sortable">中英1套</td>
                            <td class="sortable">中英2套</td>
                            <td class="sortable">中数1套</td>
                            <td class="sortable">中数2套</td>
                        </tr>
                        </thead>
                        <tbody>
                        <%for(var j=0;j< resKey.length;j++){%>
