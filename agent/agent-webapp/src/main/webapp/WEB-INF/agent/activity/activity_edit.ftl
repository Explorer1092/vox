                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="startDate" name="startDate"
                               class="startDate js-postData input-xlarge focused js-needed"
                               type="text"
                               data-needInfo="开始日期不能为空"
                               data-einfo="请选择开始日期"
                               value="${activity.startDate?string('yyyy-MM-dd')}">
                    </div>
                </div>
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input id="endDate" name="endDate"
                               class="endDate js-postData input-xlarge focused js-needed"
                               type="text"
                               data-einfo="请选择结束日期"
                               value="${activity.endDate?string('yyyy-MM-dd')}">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="focusedInput">原价</label>
                    <div class="controls">
                        <input name="originalPrice" class="js-postData input-xlarge focused" type="text" value="${activity.originalPrice!''}">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="focusedInput">现价</label>
                    <div class="controls">
                        <input name="presentPrice" class="js-postData input-xlarge focused" type="text" value="${activity.presentPrice!''}">
                    </div>
                </div>
