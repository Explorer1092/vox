        ...
        <div class="box-content school_manage">
            <form class="form-horizontal">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input name="title" id="title" maxlength="15" class="js-postData input-xlarge focused js-needed" type="text" data-einfo="请填写事项名称">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="focusedInput">联系人姓名</label>
                    <div class="controls">
                        <input id="contact" name="contact" maxlength="10" class="js-postData input-xlarge focused js-needed" type="text" data-einfo="请填写联系人姓名">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="focusedInput">邮箱</label>
                    <div class="controls">
                        <input id="email" name="email" maxlength="30" class="js-postData input-xlarge focused js-needed" type="text" data-einfo="请填写邮箱">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="focusedInput">微信群</label>
                    <div class="controls">
                        <input id="wechatGroup" name="wechatGroup" maxlength="20" class="js-postData input-xlarge focused" type="text">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label" for="focusedInput">说明</label>
                    <div class="controls">
                        <textarea name="comment" id="comment" maxlength="200" class="js-postData input-xlarge focused" cols="30" rows="5"></textarea>
                    </div>
                </div>
                <div class="control-group">
...
<script id="packetListAdd" type="text/html">
    <option value="">请选择</option>
    <%for(var i = 0; i< res.length; i++){%>
    <%var data = res[i]%>
...
<script type="text/javascript">
    $(function(){
        ...
        $(document).on('change','.first',function () {
            ...
            _this.parent().parent().next().find('.second').html(template('packetListAdd',{res:list || ''}));
        });
    });
</script>
</@layout_default.page>
