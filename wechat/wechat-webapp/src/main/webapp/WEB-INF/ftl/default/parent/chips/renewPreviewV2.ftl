...
<@layout.page title="${sharePrimeTitle!}"  pageJs="renewPreviewV2">
...
<div class="today_study" v-cloak id="today_study_normal">
    <div class="container">
        ...
        <template v-for="(item, i) in templateList">
            <div v-if="item.type === 'text' && item.value!==''" class="dialog_box">
                <div class="portrait">
                    <div class="img">
            ...
            <div v-if="item.type === 'image' && item.value!==''"  class="dialog_box" style="margin: 1rem 3rem 0 0rem;">
                <div class="portrait">
                    <div class="img">
                        <img v-bind:src="teacher.headPortrait" alt="portrait">
                    </div>
                ...
                <div class="dialog_box_container dialog_box_iconArrow">
                    <div class="content" style="width: 100%;" v-on:click="lookImageEvent(item.value,i,$event)" >
                        <img v-bind:src="item.value" style="width:100%" >
                    </div>
