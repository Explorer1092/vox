...
<div class="train-wrap bg-blue">
    <div class="train02-box">
        ...
        <div class="inner">
            <h2 class="tit02"></h2>
            <p><span>1</span>分析孩子写不好字的原因</p>
            <p><span>2</span>详细讲述正确执笔，坐姿对写字的重要性</p>
            <p><span>3</span>老师与学生的问答，正确执笔坐姿的演示</p>
        </div>
        <div class="inner">
            <h2 class="tit03"></h2>
            <ul>
                <li><img src="<@app.link href="/public/images/parent/openclass/adtg_intro01.png"/>" ></li>
                <li><img src="<@app.link href="public/images/parent/openclass/adtg_intro02.png"/>" ></li>
                <li><img src="<@app.link href="public/images/parent/openclass/adtg_intro03.png"/>" ></li>
                <li><img src="<@app.link href="public/images/parent/openclass/adtg_intro04.png"/>" ></li>
            </ul>
        </div>
        <div class="num">
