    ...
    <div class="adContainer" id="ad" v-cloak style="overflow-y: auto;overflow-x: hidden">
        ...
        <div class="adVideo" @touchstart = 'play'>
            ...
            <div class="videoMessage">
                ...
                <div class="beginBox">
                    <div class="beginText beginTime"><i></i>开课时间：2018年7月8日</div>
                    <div class="beginText beginCycle"><i></i>课程时长：12天集训+90天有效期</div>
                    <div class="beginText beginCourse"><i></i>课程：旅行口语集训营</div>
                </div>
            </div>
            <!-- 新增 箭头 -->
        ...
        <div class="adLanguage adSchedule" style="padding-bottom: 5rem;">
            ...
            <p class="adText">报名截止时间：2018年07月06日</p>
            <p class="adText02">（名额有限，售完即止）</p>
            <p class="adText">开课时间：2018年07月08日</p>
            <p class="adText02">（课程有效期：2018.07.08—2018.10.05）</p>
            <div class="dateBox">
                <ul>
                    <li><img src="/public/images/parent/chips/ad-datePic01.png" alt=""></li>
                    <li><img src="/public/images/parent/chips/ad-datePic02.png" alt=""></li>
                    <li><img src="/public/images/parent/chips/ad-datePic03.png" alt=""></li>
                    <li><img src="/public/images/parent/chips/ad-datePic04.png" alt=""></li>
                </ul>
            </div>
                ...
                <div class="adFooter">
                    <div class="footInner">
                        <div class="footCont">
                            ...
                            <a href="/chips/center/reservepay.vpage?productId=${productId ! ''}&inviter=${inviter ! ''}"><span class="priceBtn buy-btn" data-productid="${productId ! ''}" data-inviter="${inviter ! ''}"><i></i></span></a>
                            <div class="footTips">限量800人，预购从速</div>
                        </div>
                    </div>
                </div>
            </#if>
