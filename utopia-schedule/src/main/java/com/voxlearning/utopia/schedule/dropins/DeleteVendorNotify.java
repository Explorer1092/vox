...
/**
 * 删除不必要的VOX_VENDOR_NOTIFY数据（7天以上）
 * Created by Shuai Huan on 2015/6/18.
 */
@SweeperTask
public class DeleteVendorNotify extends AbstractSweeperTask {
    ...
    public void execute(Map<String, Object> beans) {
        ...
        vendorManagementClient.scheduleDeleteVendorNotify();
    }
}
