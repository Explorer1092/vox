 ...
 */
@Named
public class DaiTeAllNaturalSpellingTypeTemple implements DaiTeTypeTemplate {
    ...
    public DaiTeType getDaiTeType() {
        return DaiTeType.ALL_NATURAL_SPELLING;
    }
    ...
    public Object getDaiTeDataByType(NewHomeworkContentLoaderMapper mapper, Map params) {
        ...
        int naturalSpellingLevel = SafeConverter.toInt(params.get("naturalSpellingLevel"));
        ...
        return newHomeworkContentService.loadNaturalSpellingContent(teacherDetail, mapper.getBookId(), mapper.getUnitId(), objectiveConfigId, naturalSpellingLevel);
    }
}
