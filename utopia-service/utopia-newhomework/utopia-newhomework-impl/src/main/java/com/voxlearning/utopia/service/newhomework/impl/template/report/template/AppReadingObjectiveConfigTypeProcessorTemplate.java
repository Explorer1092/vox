...
@Named
public class AppReadingObjectiveConfigTypeProcessorTemplate extends AppObjectiveConfigTypeProcessorTemplate {
    @Override
    ...
    public void fetchTypePart(TypePartContext typePartContext) {
        ...
        List<ReadingAppTypePart.Book> books = target.getApps()
                ...
                .map(o -> {
                    ...
                    if (pictureBookMap.containsKey(o.getPictureBookId())) {
                        PictureBook pictureBook = pictureBookMap.get(o.getPictureBookId());
                        book.setTabName(pictureBook.getName());
                    }
                    ObjectiveConfigTypeParameter param = new ObjectiveConfigTypeParameter();
                    param.setPictureBookId(o.getPictureBookId());
                    String url = UrlUtils.buildUrlQuery("/view/reportv5/clazz/readingdetail",
                            MapUtils.m(
