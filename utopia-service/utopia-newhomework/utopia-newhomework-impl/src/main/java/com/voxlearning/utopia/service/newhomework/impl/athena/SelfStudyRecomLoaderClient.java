...
import com.voxlearning.athena.api.recom.loader.ISelfStudyRecomLoader;
import com.voxlearning.athena.api.recom.loader.UtopiaPsrLoader;
import lombok.Getter;

import javax.inject.Named;

@Named("com.voxlearning.utopia.service.newhomework.impl.athena.SelfStudyRecomLoaderClient")
public class SelfStudyRecomLoaderClient {

    @Getter
    @ImportService(interfaceClass = ISelfStudyRecomLoader.class)
    private ISelfStudyRecomLoader selfStudyRecomLoader;
