 ...
 */
@Named
@RequireObjectiveConfigTypes({ObjectiveConfigType.ORAL_PRACTICE})
public class Vacationcalculator_OralPractice extends SpringContainerSupport implements VacationCalculator {
    @Inject
