...
@Named
public class VacationProcessNewHomeworkAnswerDetailBasicAppTemplate extends VacationProcessNewHomeworkAnswerDetailTemplate {
    @Override
            ...
            if (practiceType.getNeedRecord()) {
                if (MapUtils.isNotEmpty(appAnswer.getAnswers())) {
                    ...
                    for (String newHomeworkProcessId : answers.values()) {
                        VacationHomeworkProcessResult n = newHomeworkProcessResultMap.get(newHomeworkProcessId);
                        if (n != null) {
