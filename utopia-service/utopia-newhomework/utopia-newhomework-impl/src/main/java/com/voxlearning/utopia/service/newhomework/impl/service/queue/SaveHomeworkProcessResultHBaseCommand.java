...
@Getter
@Setter
public class SaveHomeworkProcessResultHBaseCommand implements Serializable {

    private static final long serialVersionUID = -8574760593844494652L;

    private List<SubHomeworkProcessResult> results;
