...
@Named
@CacheBean(type = SubHomeworkResult.class, cacheName = "utopia-homework-cache")
@CacheDimension(CacheDimensionDistribution.ID_AND_OTHER_FIELDS)
public class SubHomeworkResultAsyncDao extends AsyncDynamicMongoPersistence<SubHomeworkResult, String> {
    ...
    public SubHomeworkResult updateNewHomeworkResultUrge(SubHomeworkResult subHomeworkResult) {
        ...
        SubHomeworkResult modified = $executeFindOneAndUpdate(createMongoConnection(namespace), criteria, update, options).getUninterruptibly();
        if (modified != null) {
    ...
    public Set<SubHomeworkResult.Location> findByHomework(String day, Subject subject, String homeworkId) {
