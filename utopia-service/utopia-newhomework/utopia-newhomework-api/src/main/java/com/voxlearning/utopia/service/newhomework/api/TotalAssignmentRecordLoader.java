...
public interface TotalAssignmentRecordLoader extends IPingable {

    @Idempotent
    Map<String, TotalAssignmentRecord> loadTotalAssignmentRecordByContentType(Subject subject, Collection<String> contentIds, HomeworkContentType contentType);
}
