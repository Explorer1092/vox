...
import com.voxlearning.utopia.service.newhomework.impl.listener.CommandCounter;
...
import com.voxlearning.utopia.service.newhomework.provider.management.utils.MethodUtils;
...
@RequestMapping("/newhomework-provider")
public class NewHomeworkController {

    public static final NewHomeworkController INSTANCE = new NewHomeworkController();
    ...
    public String index(Model model, HttpServletRequest httpServletRequest) {
        ...
        Set<String> beans = ApplicationContextScanner.getInstance()
                .getBeansOfType(NewHomeworkEntrance.class)
                .values()
                .stream()
