...
@Install
@MBeanInfo(type = JmxType.monitor, name = "JPSInvocation")
@MonitorPointInfo(id = "JPSInvocation", measurement = "push")
final public class JPSInvocation extends InvocationMonitorPoint {
}
