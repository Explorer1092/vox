...
@DocumentCollection(collection = "bigdata_termreport_daily")

@UtopiaCacheExpiration(policy = CachedObjectExpirationPolicy.today)
@UtopiaCacheRevision("20161027")
public class termReportDaily implements Serializable {
    private static final long serialVersionUID = 1430090686281328314L;
