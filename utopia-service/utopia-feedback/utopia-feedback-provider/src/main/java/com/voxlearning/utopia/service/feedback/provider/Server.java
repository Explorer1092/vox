...
package com.voxlearning.utopia.service.feedback.provider;

import com.voxlearning.alps.bootstrap.core.StandaloneServer;
import com.voxlearning.alps.bootstrap.core.UseSpringConfig;

/**
 * Utopia feedback server implementation.
 *
 * @author Xiaohai Zhang
 * @since Jan 16, 2015
 */
@UseSpringConfig("classpath*:/config/utopia-feedback-provider.xml")
