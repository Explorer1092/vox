...
@Named("com.voxlearning.utopia.service.vendor.impl.persistence.MDBVendorResgContentPersistence")
public class MDBVendorResgContentPersistence extends DerbyPersistence<MDBVendorResgContent, Long> {
}
