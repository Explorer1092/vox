...
@Named("com.voxlearning.utopia.service.vendor.provider.schedule.ReloadVendorAppsBufferJob")
@ScheduledJobDefinition(jobName = "ReloadVendorAppsBufferJob", cronExpression = "0 */5 * * * ?")
@ProgressTotalWork(100)
public class ReloadVendorAppsBufferJob extends ProgressedScheduleJob {
    ...
    protected void executeJob(long startTimestamp,
        ...
        vendorAppsService.reloadVendorAppsBuffer();
