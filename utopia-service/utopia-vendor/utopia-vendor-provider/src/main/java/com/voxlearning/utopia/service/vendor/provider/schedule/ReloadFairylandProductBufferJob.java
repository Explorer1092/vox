...
@Named("com.voxlearning.utopia.service.vendor.provider.schedule.ReloadFairylandProductBufferJob")
@ScheduledJobDefinition(jobName = "ReloadGlobalTagBufferJob", cronExpression = "0 */5 * * * ?")
@ProgressTotalWork(100)
public class ReloadFairylandProductBufferJob extends ProgressedScheduleJob {
    ...
    protected void executeJob(long startTimestamp, Map<String, Object> parameters, ISimpleProgressMonitor progressMonitor) {
        fairylandProductService.reloadFairylandProductBuffer();
