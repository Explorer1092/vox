...
@Named("com.voxlearning.utopia.service.vendor.provider.schedule.ReloadVendorResgContentBufferJob")
@ScheduledJobDefinition(jobName = "ReloadVendorResgContentBufferJob", cronExpression = "0 */5 * * * ?")
@ProgressTotalWork(100)
public class ReloadVendorResgContentBufferJob extends ProgressedScheduleJob {
    ...
    protected void executeJob(long startTimestamp,
        ...
        vendorResgContentService.reloadVendorResgContentBuffer();
