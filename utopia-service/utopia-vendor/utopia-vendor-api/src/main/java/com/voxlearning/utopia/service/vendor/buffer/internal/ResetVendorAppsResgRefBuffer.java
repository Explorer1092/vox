...
@Install
final public class ResetVendorAppsResgRefBuffer extends AbstractTestExecutionListener {

    @Override
    public void beforeTestMethod(TestContext testContext) throws Exception {
        ApplicationContextScanner.getInstance()
                .getBeansOfType(ApplicationContextScanner.Scope.ALL, VendorAppsResgRefBuffer.Aware.class)
                .stream()
                .map(NamedBean::getBean)
                .forEach(VendorAppsResgRefBuffer.Aware::resetVendorAppsResgRefBuffer);
    }
}
