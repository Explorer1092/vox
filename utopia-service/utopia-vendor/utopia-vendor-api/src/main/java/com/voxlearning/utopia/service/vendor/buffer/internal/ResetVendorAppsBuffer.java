...
@Install
final public class ResetVendorAppsBuffer extends AbstractTestExecutionListener {

    @Override
    public void beforeTestMethod(TestContext testContext) throws Exception {
        ApplicationContextScanner.getInstance()
                .getBeansOfType(ApplicationContextScanner.Scope.ALL, VendorAppsBuffer.Aware.class)
                .stream()
                .map(NamedBean::getBean)
                .forEach(VendorAppsBuffer.Aware::resetVendorAppsBuffer);
    }
}
