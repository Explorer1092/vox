...
@Named
public class LoadStudentAppKidsDayHomeworkCard extends AbstractStudentAppIndexDataLoader {

    public StudentAppIndexDataContext doAppProcess(StudentAppIndexDataContext context) {

        NewHomework.Location location = context.__kidsDayHomeworkLocations.stream()
    ...
    private Map<String, Object> generateHomeworkCard(StudentIndexDataContext context, String homeworkId) {
        ...
        if (newHomework == null || HomeworkTag.KidsDay != newHomework.getHomeworkTag()) {
            return null;
        }
