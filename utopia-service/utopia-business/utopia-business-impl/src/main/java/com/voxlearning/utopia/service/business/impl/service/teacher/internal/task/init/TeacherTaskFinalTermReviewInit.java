...
@Named
@Slf4j
public class TeacherTaskFinalTermReviewInit extends AbstractTeacherTaskInit implements InitializingBean {
    ...
    public void initAddJexlContext(TeacherDetail teacherDetail, JexlContext jexlContext) {
        boolean content = FinalReviewConfigUtils.isTermReviewSchool(teacherDetail.getTeacherSchoolId());
    ...
    public TeacherTaskTpl.Tpl getTeacherTaskTpl() {
        return TeacherTaskTpl.Tpl.FINAL_TERM_REVIEW;
    }
