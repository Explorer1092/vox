...
@Named("com.voxlearning.utopia.service.reward.impl.dao.TeachingResourceVersion")
public class TeachingResourceVersion extends CommonVersionSupport {

    @Inject
    private DataSourceConnectionBuilder dataSourceConnectionBuilder;

    public TeachingResourceVersion() {
        super("teaching.resource", 1);
    }
