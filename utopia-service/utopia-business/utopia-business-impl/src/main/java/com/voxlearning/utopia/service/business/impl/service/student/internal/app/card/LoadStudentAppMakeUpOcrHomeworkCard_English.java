...
/**
 * @Description: 学生APP-英语纸质作业补做卡片
 * @author: Mr_VanGogh
 * @date: 2019/2/22 下午5:43
 */
@Named
public class LoadStudentAppMakeUpOcrHomeworkCard_English extends AbstractStudentAppIndexDataLoader {

    @Override
    protected StudentAppIndexDataContext doAppProcess(StudentAppIndexDataContext context) {
        if (context.__ignoreMakeUpOcrEnglishHomework) {
            return context;
        }
