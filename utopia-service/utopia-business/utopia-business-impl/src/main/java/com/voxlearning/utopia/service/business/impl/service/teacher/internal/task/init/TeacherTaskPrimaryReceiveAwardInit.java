...
@Named
@Slf4j
public class TeacherTaskPrimaryReceiveAwardInit extends AbstractTeacherTaskInit implements InitializingBean {
    ...
    public TeacherTaskEntry getTeacherTaskEntry(TeacherDetail teacherDetail, TeacherTask teacherTask, TeacherTaskProgress teacherTaskProgress) {
        ...
        teacherTaskEntry.addReward(SafeConverter.toString(50), TeacherTaskTpl.RewardUnit.integral.name(), "次");
    ...
    public TeacherTaskTpl.Tpl getTeacherTaskTpl() {
        return TeacherTaskTpl.Tpl.PRIMARY_RECEIVE_AWARD;
    }
