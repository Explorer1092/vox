 ...
 */
@Named
public class LoadStudentTermReviewHomeworkCard_Chinese extends AbstractStudentIndexDataLoader {
    @Override
    protected StudentIndexDataContext doProcess(StudentIndexDataContext context) {
        ...
        context.__ignoreMakeUpChineseTermReviewHomework = true;
        ...
        // 当存在未检查的未过期的未完成的已经开始的语文作业时才可能显示语文作业卡
