...
/**
 * @Description: 学生APP-数学纸质作业卡片
 * @author: Mr_VanGogh
 * @date: 2019/2/22 下午5:39
 */
@Named
public class LoadStudentAppOcrHomeworkCard_Math extends AbstractStudentAppIndexDataLoader {
    ...
    protected StudentAppIndexDataContext doAppProcess(StudentAppIndexDataContext context) {
        ...
        context.__ignoreMakeUpOcrMathHomework = true;
