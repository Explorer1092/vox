 ...
 * @Description: 单元检测卡片
 * @author: Mr_VanGogh
 * @date: 2019/3/26 下午3:15
 */
@Named
public class LoadStudentAppUnitTestCard extends AbstractStudentAppIndexDataLoader {
    @Inject private NewExamResultLoaderClient newExamResultLoaderClient;
        ...
        if (studentDetail != null && studentDetail.getClazz() != null) {
            ...
            if (CollectionUtils.isNotEmpty(newExams)) {
                ...
                if (CollectionUtils.isNotEmpty(unSubmitExamList)) {
                    ...
                    resultMap.put("types", Collections.singletonList("NEWEXAM"));
                    resultMap.put("url", "/view/mobile/student/junior/newexamv2/unitlist");
                    // 安卓endDate可以为null, ios的endDate可以为空字符转
                    if (StringUtils.equalsIgnoreCase("ios", context.sys)) {
