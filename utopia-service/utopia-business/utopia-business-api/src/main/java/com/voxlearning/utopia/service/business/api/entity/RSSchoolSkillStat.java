...
@DocumentCollection(collection = "rs_school_skill_stat_{}", dynamic = true)
@DocumentIndexes({
...
public class RSSchoolSkillStat implements Serializable, TimestampTouchable {
    private static final long serialVersionUID = 4116976319176186736L;
