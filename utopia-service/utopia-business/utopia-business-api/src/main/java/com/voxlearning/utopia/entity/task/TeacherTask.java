...
/**
 * 结构需要与TeacherTaskLog保持一致
 */
@Getter
@Setter
@DocumentConnection(configName = "hs_misc")
@DocumentTable(table = "VOX_TEACHER_TASK")
@UtopiaCacheRevision("20181029")
public class TeacherTask extends AbstractDatabaseEntityWithDisabledField implements CacheDimensionDocument{
    ...
    public boolean isInHistory(){
        return Status.FINISHED.name().equals(status) || Status.EXPIRED.name().equals(status);
    }
}
