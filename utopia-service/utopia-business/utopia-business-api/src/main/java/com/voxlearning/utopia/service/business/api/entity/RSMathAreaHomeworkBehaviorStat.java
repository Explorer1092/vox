...
@DocumentCollection(collection = "rs_math_area_homework_behavior_stat_{}", dynamic = true)
@DocumentIndexes({
        @DocumentIndex(def = "{'ccode':1}", background = true),
        @DocumentIndex(def = "{'acode':1}", background = true)
})
public class RSMathAreaHomeworkBehaviorStat extends AbstractRSAreaHomeworkBehaviorStat implements Serializable {
