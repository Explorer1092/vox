...
@DocumentCollection(collection = "rs_eng_school_homework_behavior_stat_{}", dynamic = true)
@DocumentRangeable(range = DateRangeType.Y, age = 0)
@DocumentIndexes({
...
public class RSEnglishSchoolHomeworkBehaviorStat extends AbstractRSSchoolHomeworkBehaviorStat implements Serializable {

    private static final long serialVersionUID = -3195763745271225186L;
}
