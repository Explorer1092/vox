 ...
 * 角色数据
 */
public class RoleInfo extends AbstractMessageBean implements Serializable {
     ...
     * 角色对应装备列表
     */
    public Collection<EquipInfo> equipList = new ArrayList<>();
    /**
     * 角色对应精灵列表
     */
    public Collection<SpriteInfo> spriteList = new ArrayList<>();
    /**
     * 角色对应技能列表
     */
    public Collection<SpellInfo> spellList = new ArrayList<>();
