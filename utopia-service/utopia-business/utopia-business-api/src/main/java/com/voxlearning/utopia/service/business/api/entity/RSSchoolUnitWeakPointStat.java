...
@DocumentCollection(collection = "rs_school_unit_weakpoint_stat_{}", dynamic = true)
@DocumentIndexes({
...
public class RSSchoolUnitWeakPointStat implements Serializable, TimestampTouchable {
    private static final long serialVersionUID = 4929629486850843143L;
    ...
    private List<RSLevelData> weakPoint;
