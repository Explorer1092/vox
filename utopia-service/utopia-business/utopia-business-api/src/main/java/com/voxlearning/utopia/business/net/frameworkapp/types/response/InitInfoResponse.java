...
package com.voxlearning.utopia.business.net.frameworkapp.types.response;

import com.voxlearning.alps.spi.common.JsonStringSerializer;
import com.voxlearning.utopia.business.net.frameworkapp.types.IPInfo;
import com.voxlearning.utopia.business.net.frameworkapp.types.UserInfo;
...
public class InitInfoResponse extends AbstractMessageBean implements Serializable {
     ...
     * IP列表
     */
    public Collection<IPInfo> ipList = new ArrayList<>();
