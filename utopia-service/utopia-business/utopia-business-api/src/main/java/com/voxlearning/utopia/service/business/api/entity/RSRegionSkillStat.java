...
@DocumentCollection(collection = "rs_region_skill_stat_{}", dynamic = true)
@DocumentIndexes({
...
public class RSRegionSkillStat implements Serializable, TimestampTouchable {
    private static final long serialVersionUID = -207651369266902622L;
