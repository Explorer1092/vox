...
@DocumentCollection(collection = "rs_eng_area_homework_behavior_stat_{}", dynamic = true)
...
public class RSEnglishAreaHomeworkBehaviorStat extends AbstractRSAreaHomeworkBehaviorStat implements Serializable {
