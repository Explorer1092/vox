 ...
 * 购买消息，购买后自动使用
 */
public class BuyItemRequest extends AbstractMessageBean implements Serializable {
    ...
    public static BuyItemRequest parseRequest(String input) {
        BuyItemRequest result = new BuyItemRequest();
     ...
     */
    public static BuyItemResponse newResponse() {
