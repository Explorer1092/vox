...
@DocumentCollection(collection = "rs_region_knowledge_stat_{}", dynamic = true)
@DocumentIndexes({
...
public class RSRegionKnowledgeStat implements Serializable, TimestampTouchable {
    private static final long serialVersionUID = -43361773399822389L;
