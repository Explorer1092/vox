...
@DocumentCollection(collection = "rs_region_unit_weakpoint_stat_{}", dynamic = true)
@DocumentIndexes({
...
public class RSRegionUnitWeakPointStat implements Serializable, TimestampTouchable {
    private static final long serialVersionUID = 6106659057299391990L;
