...
@DocumentCollection(collection = "rs_region_skill_month_stat_{}", dynamic = true)
@DocumentIndexes({
...
public class RSRegionSkillMonthlyStat implements Serializable, TimestampTouchable {
    private static final long serialVersionUID = 8613605350567073158L;
