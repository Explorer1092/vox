...
@ServiceRetries
public interface AgentUserSchoolService extends IPingable {

    Long persist(AgentUserSchool userSchool);

    Boolean update(Long userSchoolId, AgentUserSchool userSchool);
