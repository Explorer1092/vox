...
public class TestActionEventWeekRangeCounter {
    @Inject
    private ActionEventWeekRangeCounter actionEventWeekRangeCounter;
    ...
    public void testActionEventDayRangeCounter() throws Exception {
        ...
        assertEquals(1, actionEventWeekRangeCounter.increase(event));
        assertEquals(2, actionEventWeekRangeCounter.increase(event));
        assertEquals(3, actionEventWeekRangeCounter.increase(event));
    }
}
