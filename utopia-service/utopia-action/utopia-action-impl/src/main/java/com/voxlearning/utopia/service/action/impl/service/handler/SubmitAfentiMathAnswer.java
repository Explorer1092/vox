 ...
 * 成长: 1次/每天，5次/每周
 */
@Named("actionEventHandler.submitAfentiMathAnswer")
public class SubmitAfentiMathAnswer extends AbstractActionEventHandler {
    @Override
    public ActionEventType getEventType() {
        return ActionEventType.SubmitAfentiMathAnswer;
    }
