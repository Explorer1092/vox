 ...
 */
@UtopiaCachePrefix(prefix = "class_zone_plot_finished")
@UtopiaCacheExpiration(policy = CachedObjectExpirationPolicy.today)
public class ClassPlotFinishedCountCache extends PojoCacheObject<String, Long> {
    public static final String KEY = "count_";
    protected ClassPlotFinishedCountCache(UtopiaCache cache) {
        super(cache);
    }
