...
@Named("com.voxlearning.utopia.service.zone.impl.persistence.MDBUserMoodPersistence")
public class MDBUserMoodPersistence extends DerbyPersistence<MDBUserMood, Long> {
}
