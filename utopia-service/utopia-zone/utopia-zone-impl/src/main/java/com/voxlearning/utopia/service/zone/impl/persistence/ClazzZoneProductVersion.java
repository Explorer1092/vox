...
@Named("com.voxlearning.utopia.service.zone.impl.persistence.ClazzZoneProductVersion")
public class ClazzZoneProductVersion extends CommonVersionSupport {

    @Inject private DataSourceConnectionBuilder dataSourceConnectionBuilder;

    public ClazzZoneProductVersion() {
        super("zone.ClazzZoneProduct", 100);
    }
