...
@Named("com.voxlearning.utopia.service.zone.impl.persistence.UserMoodVersion")
public class UserMoodVersion extends CommonVersionSupport {

    @Inject private DataSourceConnectionBuilder dataSourceConnectionBuilder;

    public UserMoodVersion() {
        super("zone.UserMood", 100);
    }
