...
@Named("com.voxlearning.utopia.service.zone.provider.schedule.ReloadUserMoodBufferJob")
@ScheduledJobDefinition(jobName = "ReloadUserMoodBufferJob", cronExpression = "0 */5 * * * ?")
@ProgressTotalWork(100)
public class ReloadUserMoodBufferJob extends ProgressedScheduleJob {
    ...
    protected void executeJob(long startTimestamp, Map<String, Object> parameters, ISimpleProgressMonitor progressMonitor) {
        userMoodService.reloadUserMoodBuffer();
