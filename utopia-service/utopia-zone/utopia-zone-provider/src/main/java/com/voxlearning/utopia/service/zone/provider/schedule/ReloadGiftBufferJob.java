...
@Named("com.voxlearning.utopia.service.zone.provider.schedule.ReloadGiftBufferJob")
@ScheduledJobDefinition(jobName = "ReloadGiftBufferJob", cronExpression = "0 */5 * * * ?")
@ProgressTotalWork(100)
public class ReloadGiftBufferJob extends ProgressedScheduleJob {
    ...
    protected void executeJob(long startTimestamp, Map<String, Object> parameters, ISimpleProgressMonitor progressMonitor) {
        zoneGiftService.reloadGiftBuffer();
