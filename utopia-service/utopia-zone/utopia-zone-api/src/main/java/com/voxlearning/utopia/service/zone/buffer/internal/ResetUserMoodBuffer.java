...
@Install
final public class ResetUserMoodBuffer extends AbstractTestExecutionListener {

    @Override
    public void beforeTestMethod(TestContext testContext) throws Exception {
        ApplicationContextScanner.getInstance()
                .getBeansOfType(ApplicationContextScanner.Scope.ALL, UserMoodBuffer.Aware.class)
                .stream()
                .map(NamedBean::getBean)
                .forEach(UserMoodBuffer.Aware::resetUserMoodBuffer);
    }
}
