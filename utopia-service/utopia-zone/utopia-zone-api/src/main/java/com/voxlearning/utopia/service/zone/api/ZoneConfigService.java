...
@ServiceVersion(version = "2017.01.22")
...
public interface ZoneConfigService {
    ...
    @Async
    @Deprecated
    AlpsFuture<VersionedClazzZoneProductData> loadVersionedClazzZoneProductData(long version);

    @Async
    @Deprecated
    AlpsFuture<VersionedGiftData> loadVersionedGiftData(long version);

    @Async
    @Deprecated
    AlpsFuture<VersionedUserMoodData> loadVersionedUserMoodData(long version);
}
