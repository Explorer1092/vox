...
@Install
final public class ResetGiftBuffer extends AbstractTestExecutionListener {

    @Override
    public void beforeTestMethod(TestContext testContext) throws Exception {
        ApplicationContextScanner.getInstance()
                .getBeansOfType(ApplicationContextScanner.Scope.ALL, GiftBuffer.Aware.class)
                .stream()
                .map(NamedBean::getBean)
                .forEach(GiftBuffer.Aware::resetGiftBuffer);
    }
}
