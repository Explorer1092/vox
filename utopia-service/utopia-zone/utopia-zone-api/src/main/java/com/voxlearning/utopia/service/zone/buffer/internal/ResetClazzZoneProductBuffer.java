...
@Install
final public class ResetClazzZoneProductBuffer extends AbstractTestExecutionListener {

    @Override
    public void beforeTestMethod(TestContext testContext) throws Exception {
        ApplicationContextScanner.getInstance()
                .getBeansOfType(ApplicationContextScanner.Scope.ALL, ClazzZoneProductBuffer.Aware.class)
                .stream()
                .map(NamedBean::getBean)
                .forEach(ClazzZoneProductBuffer.Aware::resetClazzZoneProductBuffer);
    }
}
