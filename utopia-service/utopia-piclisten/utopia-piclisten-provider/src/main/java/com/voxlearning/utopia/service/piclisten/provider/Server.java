...
package com.voxlearning.utopia.service.piclisten.provider;

import com.voxlearning.alps.bootstrap.core.StandaloneServer;
import com.voxlearning.alps.bootstrap.core.UseSpringConfig;

/**
 * Utopia piclisten server implementation.
 *
 * @author Xiaohai Zhang
 * @since Feb 10, 2015
 */
@UseSpringConfig("classpath*:/config/utopia-piclisten-provider.xml")
