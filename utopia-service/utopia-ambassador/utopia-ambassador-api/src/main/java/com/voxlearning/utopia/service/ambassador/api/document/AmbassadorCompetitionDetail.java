...
@DocumentTable(table = "VOX_AMBASSADOR_COMPETITION_DETAIL")
@UtopiaCacheExpiration
@UtopiaCacheRevision("20160806")
public class AmbassadorCompetitionDetail extends AbstractDatabaseEntity implements CacheDimensionDocument {
    private static final long serialVersionUID = 1506396461772132183L;

    private Long teacherId;
    private Long targetUserId;
    private Integer score;
    private AmbassadorCompetitionScoreType scoreType; //AmbassadorCompetitionScoreType
