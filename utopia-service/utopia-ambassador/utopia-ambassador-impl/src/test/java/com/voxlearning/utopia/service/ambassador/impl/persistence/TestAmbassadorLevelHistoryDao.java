...
@TruncateDatabaseTable(databaseEntities = AmbassadorLevelHistory.class)
public class TestAmbassadorLevelHistoryDao {

    @Inject private AmbassadorLevelHistoryDao ambassadorLevelHistoryDao;

    @Test
    public void testAmbassadorLevelHistoryDao() throws Exception {
        AmbassadorLevelHistory history = new AmbassadorLevelHistory();
        history.setMonth(0);
        ambassadorLevelHistoryDao.insert(history);
        assertNotNull(ambassadorLevelHistoryDao.load(history.getId()));
    }
}
