...
/**
 * 按关卡排列出所有的单词以及角色已获得的单词拼图
 */
public class AllStagePuzzleList extends AbstractMessageBean implements Serializable {
     ...
     * ${var.@comment}
     */
    public Collection<StagePuzzleList> stagePuzzleList = new ArrayList<>();
