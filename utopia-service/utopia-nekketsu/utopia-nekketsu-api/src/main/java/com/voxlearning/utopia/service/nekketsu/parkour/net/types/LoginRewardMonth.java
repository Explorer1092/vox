 ...
 * 某个月的奖励率列表
 */
public class LoginRewardMonth extends AbstractMessageBean implements Serializable {
     ...
     * 该月奖品到期倒计时
     */
    public int expireCountdown;
    /**
     * 奖品具体信息
     */
    public Collection<PrizeDetailLogin> prizeDetailList = new ArrayList<>();
