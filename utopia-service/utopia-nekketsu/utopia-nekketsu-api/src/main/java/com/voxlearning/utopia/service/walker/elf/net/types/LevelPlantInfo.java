 ...
 *
 */
public class LevelPlantInfo extends AbstractMessageBean implements Serializable {
    ...
    /**
     * 关卡Id，取值范围：SAVE_PRINCE,SAVE_QUEEN,SAVE_KING
     */
     ...
     * 植物列表
     */
    public Collection<PlantFloorInfo> plantFloorInfoList = new ArrayList<>();
