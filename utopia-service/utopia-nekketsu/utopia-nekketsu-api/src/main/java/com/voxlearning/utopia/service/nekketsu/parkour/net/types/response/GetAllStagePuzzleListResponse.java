...
import com.voxlearning.utopia.service.nekketsu.parkour.net.types.AllStagePuzzleList;
 ...
 * 全部打过的关卡的单词以及已获得的拼图
 */
public class GetAllStagePuzzleListResponse extends AbstractMessageBean implements Serializable {
     ...
     * 全部打过的关卡的单词以及已获得的拼图
     */
    public AllStagePuzzleList allStagePuzzle;
