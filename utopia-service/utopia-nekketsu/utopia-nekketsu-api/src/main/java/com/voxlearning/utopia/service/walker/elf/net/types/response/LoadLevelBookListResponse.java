...
import com.voxlearning.utopia.service.walker.elf.net.types.BookBrief;
 ...
 * 某关的书本简要信息
 */
public class LoadLevelBookListResponse extends AbstractMessageBean implements Serializable {
     ...
     * 书本信息列表
     */
    public Collection<BookBrief> bookBriefList = new ArrayList<>();
