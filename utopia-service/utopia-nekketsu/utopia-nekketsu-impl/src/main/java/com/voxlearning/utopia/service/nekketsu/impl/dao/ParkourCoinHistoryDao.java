...
/**
 * Dao implementation of entity {@link ParkourCoinHistory}.
 *
 * @author Xiaohai Zhang
 * @since Jan 6, 2015
 */
@Named
public class ParkourCoinHistoryDao extends RangeableMongoDao<ParkourCoinHistory> {
    @Override
    protected void calculateCacheDimensions(ParkourCoinHistory source, Collection<String> dimensions) {
    }
