 ...
 */
@Named
public class StudentPicBookSchoolRankCacheManager extends SpringContainerSupport {

    private static final String READ_KEY_PREFIX = "PIC_BOOK_STUDENT_READ_RANK_";
    private static final String WORD_KEY_PREFIX = "PIC_BOOK_STUDENT_WORD_RANK_";
    ...
    public Long updateStudentRank(Long studentId, Integer total, PicBookRankCategory rankType, Long schoolId, Integer week) {
        if (studentId == null || total == null || rankType == null || schoolId == null || week == null) {
            return null;
        }
        String key = getKey(rankType, schoolId, week);
    ...
    private String getKey(PicBookRankCategory rankType, Long schoolId, Integer week) {
        if (rankType == PicBookRankCategory.READ) {
            return READ_KEY_PREFIX + schoolId + "_" + week;
        } else if (rankType == PicBookRankCategory.WORD) {
            return WORD_KEY_PREFIX + schoolId + "_" + week;
        }
        return null;
    }

    public PicBookRankInfo getStudentRankByStudentIdAndRankType(Long studentId, PicBookRankCategory rankType, Long schoolId, Integer week) {
        if (rankType == null || studentId == null || week == null || schoolId == null) {
            return null;
        }
    ...
    public List<PicBookRankInfo> getRankList(Integer limit, PicBookRankCategory rankType, Long schoolId, Integer week) {
