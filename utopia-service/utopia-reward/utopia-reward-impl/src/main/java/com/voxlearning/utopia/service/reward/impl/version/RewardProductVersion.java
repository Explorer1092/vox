...
/**
 * To replace legacy 'LatestRewardProductUpdateTimestamp'.
 */
@Named
public class RewardProductVersion extends SpringContainerSupport {

    private static final String KEY = "RewardProductVersion";
