...
@Slf4j
@NoArgsConstructor
@IdentificationCouponName(CouponProductionName.同仁堂蜂业旗舰店5元优惠券)
public class Coupon_TongRenTang5 extends CouponTemplate{
    ...
    protected String getIntegralComment() {
        return "兑换同仁堂蜂业旗舰店5元优惠券";
    }

    @Override
    protected String getSmsMessage(RewardCouponDetail couponDetail) {
        return "您已成功兑换，请到同仁堂天猫直营旗舰店，5元无门槛优惠券。复制整条信息，打开「手机淘宝」￥iau6Zxi9N1r￥(立即享受优惠)";
    }
