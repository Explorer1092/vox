...
@Slf4j
@NoArgsConstructor
@IdentificationCouponName(CouponProductionName.精锐1对1免费试听得1000学豆)
public class Coupon_Jr extends CouponTemplate {
    @Override
    ...
    protected String getIntegralComment() {
        return "预约“精锐1对1免费试听课”";
    }

    @Override
    protected String getSmsMessage(RewardCouponDetail couponDetail) {
        return "您的孩子想预约体验“精锐1对1免费试听课”需要您的同意，请及时和孩子沟通哦！";
    }

    @Override
    protected String getSystemMessage(RewardCouponDetail couponDetail) {
        return "你已经预约“精锐1对1免费试听课”，请及时和爸爸妈妈分享消息！体验课程后，你还可以获得1000学豆奖励！体验编号：" + couponDetail.getCouponNo();
    }
}