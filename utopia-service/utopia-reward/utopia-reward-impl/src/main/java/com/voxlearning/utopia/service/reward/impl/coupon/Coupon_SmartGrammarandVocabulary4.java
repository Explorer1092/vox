...
/**
 * 语法教材《Smart Grammar and Vocabulary》 系列第四册
 * Created by haitian.gan on 2017/7/6.
 */
@Named
@Slf4j
@NoArgsConstructor
@IdentificationCouponName(CouponProductionName.语法教材SmartGrammarandVocabulary系列第四册)
public class Coupon_SmartGrammarandVocabulary4 extends CouponTemplate{
    ...
    protected String getIntegralComment() {
        return "语法教材《Smart Grammar and Vocabulary》 系列第四册";
    }
