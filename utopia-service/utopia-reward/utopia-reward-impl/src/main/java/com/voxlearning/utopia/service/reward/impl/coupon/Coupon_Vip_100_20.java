...
@Slf4j
@NoArgsConstructor
@IdentificationCouponName(CouponProductionName.大使专享唯品会满100减20优惠券)
public class Coupon_Vip_100_20 extends CouponTemplate {
    @Override
    ...
    protected String getIntegralComment() {
        return "兑换唯品会（www.vip.vom）满100减20元专属优惠券";
    }

    @Override
    protected String getSystemMessage(RewardCouponDetail couponDetail) {
        return "你已经兑换唯品会（www.vip.vom）满100减20元专属优惠券，优惠券号：" + couponDetail.getCouponNo() + "，请及时使用哦！";
    }
}
