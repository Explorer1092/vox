...
/**
 * 台湾自然拼读Phonics Kids第五册
 * Created by haitian.gan on 2017/7/6.
 */
@Named
@Slf4j
@NoArgsConstructor
@IdentificationCouponName(CouponProductionName.台湾自然拼读PhonicsKids第五册)
public class Coupon_PhonicsKids5 extends CouponTemplate{
