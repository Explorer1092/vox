...
@Named("com.voxlearning.utopia.service.reward.impl.dao.RewardActivityVersion")
public class RewardActivityVersion extends CommonVersionSupport {

    @Inject
    private DataSourceConnectionBuilder dataSourceConnectionBuilder;

    public RewardActivityVersion() {
        super("reward.activity", 100);
    }
