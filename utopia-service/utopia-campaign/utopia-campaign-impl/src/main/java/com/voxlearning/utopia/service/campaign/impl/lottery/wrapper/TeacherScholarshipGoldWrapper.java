 ...
 */
@Named
public class TeacherScholarshipGoldWrapper extends AbstractCampaignWrapper {
    ...
    public MapMessage doLottery(CampaignType campaignType, final User user, LotteryClientType clientType) {
        ...
        try {
            ...
            if (SafeConverter.toInt(winLottery.get("awardId")) <= 5) {
                ...
                //发邮件
                if (RuntimeMode.ge(Mode.STAGING) && SafeConverter.toInt(winLottery.get("awardId")) <= 5) {
