 ...
 */
@Named
public class HomeworkResultBuildProcessor implements HomeworkProcessor {
    ...
    public void process(HomeworkContext hc) {
        ...
        HomeworkProcessResult hpr = hc.getHomeworkProcessResults().get(0);//结果详情
        ...
        if(ObjectUtils.get(()->hr.getFinished(), Boolean.FALSE)){
            ...
            homeworkResult.setFinished(hr.getFinished());
        }
