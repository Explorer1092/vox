...
/**
 * Created by Summer Yang on 2016/5/13.
 */
@Named
@NoArgsConstructor
public class ParentRemindForGraduateStudentFromRewardProcessor extends AbstractNoticeProcessor {
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEMPLATE_PARENT_REMIND_FOR_GRADUATE_STUDENT_FROM_REWARD.getType());
    ...
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.ParentRemindForGraduateStudentFromReward;
    }
}