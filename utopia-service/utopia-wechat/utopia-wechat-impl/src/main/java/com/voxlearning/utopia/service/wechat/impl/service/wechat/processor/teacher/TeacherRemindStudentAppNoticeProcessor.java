...
@Named
@NoArgsConstructor
public class TeacherRemindStudentAppNoticeProcessor extends AbstractNoticeProcessor {

    @Inject private WechatNoticePersistence wechatNoticePersistence;

    @Override
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.TeacherRemindStudentAppNotice;
    }
    ...
    public void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEMPLATE_PARENT_APP_NOTICE.getType());
