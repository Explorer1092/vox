...
@Named
@NoArgsConstructor
public class ChristmasParentSendIntegralNoticeProcessor extends AbstractNoticeProcessor {
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEACHER_CHRISTMAS_PARENT_SEND_INTEGRAL_NOTICE.getType());
    ...
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.ChristmasParentSendIntegralNotice;
    }
}
