...
@Named
@NoArgsConstructor
public class ParentTeachersDayNoticeProcessor extends AbstractNoticeProcessor {
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEMPLATE_PARENT_TEACHERS_DAY_NOTICE.getType());
    ...
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.ParentTeachersDayNotice;
    }
}
