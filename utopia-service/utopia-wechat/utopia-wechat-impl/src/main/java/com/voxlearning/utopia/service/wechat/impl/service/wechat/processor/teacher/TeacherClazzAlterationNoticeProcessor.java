...
@Lazy(false)
@NoArgsConstructor
public class TeacherClazzAlterationNoticeProcessor extends AbstractNoticeProcessor {
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEACHER_TEMPLATE_CLAZZ_ALTERATION_NOTICE.getType());
    ...
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.TeacherClazzAlterationNotice;
    }
}
