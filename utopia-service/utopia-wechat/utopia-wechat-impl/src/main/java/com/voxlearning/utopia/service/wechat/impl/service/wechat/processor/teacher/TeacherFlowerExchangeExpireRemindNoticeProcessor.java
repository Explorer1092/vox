...
@Named
@NoArgsConstructor
public class TeacherFlowerExchangeExpireRemindNoticeProcessor extends AbstractNoticeProcessor {
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEACHER_FLOWER_EXCHANGE_EXPIRE_REMIND_NOTICE.getType());
    ...
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.TeacherFlowerExchangeExpireRemindNotice;
    }
}
