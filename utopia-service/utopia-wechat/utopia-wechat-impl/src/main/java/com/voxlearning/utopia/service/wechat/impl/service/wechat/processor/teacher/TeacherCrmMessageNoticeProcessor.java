...
/**
 * CRM中给老师发微信消息
 * Created by Shuai Huan on 2015/4/24.
 */
@Named
@NoArgsConstructor
public class TeacherCrmMessageNoticeProcessor extends AbstractNoticeProcessor {

    @Inject private WechatNoticePersistence wechatNoticePersistence;

    @Override
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.TeacherCrmMessageNotice;
    }
    ...
    public void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEACHER_TEMPLATE_CRM_REMIND.getType());
