...
@Lazy(false)
@NoArgsConstructor
public class RemindSetMissionNoticeProcessor extends AbstractNoticeProcessor {

    @Inject private WechatNoticePersistence wechatNoticePersistence;

    @Override
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.RemindSetMissionNotice;
    }
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEMPLATE_REMIND_SET_MISSION.getType());
