...
/**
 * Created by Summer Yang on 2015/11/13.
 */
@Named
@NoArgsConstructor
public class ParentTrusteeSignpicNoticeProcessor extends AbstractNoticeProcessor {

    @Inject private WechatNoticePersistence wechatNoticePersistence;

    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.ParentTrusteeSignPicNotice;
    }

    @Override
    public void processWechat(Long userId, String openId, Map extensionInfo) {
        WechatNotice notice = new WechatNotice();
        notice.setMessageType(WechatNoticeType.TEMPLATE_PARENT_TRUSTEE_SIGNPIC_NOTICE.getType());
