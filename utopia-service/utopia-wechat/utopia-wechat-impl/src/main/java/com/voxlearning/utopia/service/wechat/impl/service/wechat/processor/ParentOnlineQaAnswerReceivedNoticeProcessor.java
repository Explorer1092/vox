...
@Named
@NoArgsConstructor
public class ParentOnlineQaAnswerReceivedNoticeProcessor extends AbstractNoticeProcessor {
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEMPLATE_PARENT_ONLINE_QA_ANSWER_RECEIVED.getType());
    ...
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.ParentOnlineQaAnswerReceivedNotice;
    }
}
