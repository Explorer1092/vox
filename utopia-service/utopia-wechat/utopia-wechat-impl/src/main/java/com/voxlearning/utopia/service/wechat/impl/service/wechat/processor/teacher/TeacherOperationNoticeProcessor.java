...
@Named
@NoArgsConstructor
public class TeacherOperationNoticeProcessor extends AbstractNoticeProcessor {
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEACHER_OPERATION_NOTICE.getType());
        ...
        map.put("template_id", WechatNoticeTemplateIds.templateId8);
    ...
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.TeacherOperationNotice;
    }
}
