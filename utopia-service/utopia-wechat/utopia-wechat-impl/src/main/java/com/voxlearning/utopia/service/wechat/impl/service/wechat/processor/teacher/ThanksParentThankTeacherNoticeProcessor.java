...
@Named
@NoArgsConstructor
public class ThanksParentThankTeacherNoticeProcessor extends AbstractNoticeProcessor {

    @Inject private WechatNoticePersistence wechatNoticePersistence;

    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.ThanksParentThankTeacherNotice;
    }

    @Override
    public void processWechat(Long userId, String openId, Map extensionInfo) {
        WechatNotice notice = new WechatNotice();
        notice.setMessageType(WechatNoticeType.TEACHER_THANKS_PARENT_THANK_TEACHER_NOTICE.getType());
