...
@Named
@NoArgsConstructor
public class TeacherAssignHomeworkExperienceProcessor extends AbstractNoticeProcessor {

    @Inject private WechatNoticePersistence wechatNoticePersistence;

    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.TeacherAssignHomeworkExperience;
    }
    ...
    public void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        map.put("subject", extensionInfo.get("subject"));
        notice.setMessageType(WechatNoticeType.TEACHER_TEMPLATE_ASSIGN_HOMEWORK_EXPERIENCE_REMIND.getType());
