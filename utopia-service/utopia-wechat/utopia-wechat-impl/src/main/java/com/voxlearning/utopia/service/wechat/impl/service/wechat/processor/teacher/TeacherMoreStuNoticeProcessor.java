...
@Lazy(false)
@NoArgsConstructor
public class TeacherMoreStuNoticeProcessor extends AbstractNoticeProcessor {
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEACHER_TEMPLATE_MORE_STU_NOTICE.getType());
    ...
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.MoreStudentNotice;
    }
}
