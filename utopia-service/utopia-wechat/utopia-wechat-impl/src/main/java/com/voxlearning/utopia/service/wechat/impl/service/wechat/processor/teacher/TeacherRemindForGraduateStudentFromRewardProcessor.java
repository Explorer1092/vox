...
@Named
@NoArgsConstructor
public class TeacherRemindForGraduateStudentFromRewardProcessor extends AbstractNoticeProcessor {
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEACHER_REMIND_FOR_GRADUATE_STUDENT_FROM_REWARD.getType());
    ...
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.TeacherRemindForGraduateStudentFromReward;
    }
}
