...
/**
 * @author xin
 * @since 14-5-22 下午4:08
 */

@Named
@Lazy(false)
@NoArgsConstructor
public class HomeworkCreateNoticeProcessor extends AbstractNoticeProcessor {

    @Inject private WechatNoticePersistence wechatNoticePersistence;

    @Override
    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.HomeworkCreateNotice;
    }
    ...
    protected void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setMessageType(WechatNoticeType.TEMPLATE_HOMEWORK_CREATE.getType());
        ...
        map.put("keyword2", Subject.ENGLISH.getValue());
        map.put("keyword3", extensionInfo.get("units") + "，共" + extensionInfo.get("practiceCount") + "题");
...
//        notice.setMessage("最新作业通知\n"
//                + "- - - - - - - - - - - - - - - \n"
//                + studentName + "家长您好：\n"
//                + teacherName + "老师刚刚布置了英语作业\n"
//                + "↓请点击“最新作业”查看");
