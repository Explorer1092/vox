...
@Named
@NoArgsConstructor
public class ThanksParentSendIntegralNoticeProcessor extends AbstractNoticeProcessor {

    @Inject private WechatNoticePersistence wechatNoticePersistence;

    public WechatNoticeProcessorType type() {
        return WechatNoticeProcessorType.ThanksParentSendIntegralNotice;
    }

    @Override
    public void processWechat(Long userId, String openId, Map extensionInfo) {
        WechatNotice notice = new WechatNotice();
        notice.setMessageType(WechatNoticeType.TEACHER_THANKS_PARENT_SEND_INTEGRAL_NOTICE.getType());
