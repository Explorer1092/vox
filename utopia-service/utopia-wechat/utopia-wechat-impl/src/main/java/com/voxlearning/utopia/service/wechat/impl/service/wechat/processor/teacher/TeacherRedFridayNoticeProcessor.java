...
public class TeacherRedFridayNoticeProcessor extends AbstractNoticeProcessor {
    ...
    public void processWechat(Long userId, String openId, Map extensionInfo) {
        ...
        notice.setSendTime(DateUtils.stringToDate(DateUtils.dateToString(new Date(), "yyyy-MM-dd") + " 15:30:00"));
