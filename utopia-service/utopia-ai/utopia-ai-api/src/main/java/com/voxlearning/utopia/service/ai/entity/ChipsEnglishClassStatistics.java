...
@DocumentCollection(collection = "vox_chips_english_class_statistics")
@UtopiaCacheExpiration(policy = CachedObjectExpirationPolicy.fixed, value = 10800)
@UtopiaCacheRevision("20190125")
public class ChipsEnglishClassStatistics implements Serializable {
    ...
    @DocumentField(value = "periodremarknum")
    ...
    public static String ck_class_id(Long classId) {
        return CacheKeyGenerator.generateCacheKey(ChipsEnglishClassStatistics.class, "CID", classId);
    }
}
