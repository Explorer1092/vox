...
@Slf4j
@NoArgsConstructor
public class SsoConnectController extends AbstractWebController {
    ...
    public String ssoLogin(@PathVariable("source") String source, Model model) {
        ...
        model.addAttribute("userName", SafeConverter.toString(dataMap.get("userName"), ""));
        model.addAttribute("userMobile", SafeConverter.toString(dataMap.get("userMobile"), ""));
