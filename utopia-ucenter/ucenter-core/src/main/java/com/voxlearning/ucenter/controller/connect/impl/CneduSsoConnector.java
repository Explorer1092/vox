...
public class CneduSsoConnector extends AbstractSsoConnector {
    ...
    private MapMessage validateTicket(String httpUrl, String ticket) {
        ...
        if (response.getStatusCode() == 200) {
            ...
            if (apiResult == null || !apiResult.containsKey("retCode") || !apiResult.get("retCode").equals("000000") || !apiResult.containsKey("data")) {
                return MapMessage.errorMessage("Failed to validate ticket");
            }

            Map<String, Object> userInfo = (Map) apiResult.get("data");
            ...
            result.add("userCode", getUserCode(dafaultIdentity));
    ...
    private static String getTicketValidateUrl() {
        return "http://gateway.system.eduyun.cn:40015/userSession/validaTicket?accessToken=";
    }

    private static String getAccessTokenGetUrl() {
        return "http://gateway.system.eduyun.cn:40015/apigateway/getAccessToken";
    }

    public static void main(String[] args) {
        CneduSsoConnector c = new CneduSsoConnector();
        String accessToken = c.getAccessToken(SsoConnections.Cnedu);
        System.out.println(accessToken);
        String httpUrl = getTicketValidateUrl() + accessToken;
        c.validateTicket(httpUrl,"ek01NzJjMmUzODItNDRhYy00ZDY2LTgyZTMtODI0NGFjY2Q2NmYxMTUyOTQ3OTIxNDIwNw==");
    }
