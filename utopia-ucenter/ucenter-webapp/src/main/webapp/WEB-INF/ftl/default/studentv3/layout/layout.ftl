...
<html>
    <head>
        ...
        <@sugar.capsule js=["jquery", "core", "alert", "template", "DD_belatedPNG", "student"] css=["plugin.alert", "new_student.base", "new_student.module", "new_student.widget"] />
    ...
    <body class="${clazzName!''}">
        ...
        <div class="m-header">
            <div class="m-inner">
                <div class="logo"><a onclick="$17.atongji('首页-导航-logo','/');" href="javascript:void(0);"></a></div>
                <div class="link">
                    <ul class="w-fl-left">
                ...
                <div class="m-foot-link w-fl-right">
                    ...
                    <div class="m-service">
                        ...
                        <p class="c-btn" style="overflow: hidden">
                            ...
                            <a style="margin-top: 10px;" href="${(ProductConfig.getMainSiteBaseUrl())!''}/help/kf/index.vpage?menu=student" class="on-service" target="_blank">帮助中心</a>
                        </p>
                    </div>
                </div>
            </div>
