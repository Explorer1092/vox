...
<head>
    ...
    <@sugar.capsule js=["jquery", "core", "alert"] css=["plugin.alert", "new_teacher.widget", "plugin.register"] />
        ...
        <div class="switch_con_box">
            ...
            <form id="loginForm" method="post" action="/j_spring_security_check">
                ...
                <ul id="signup_content_box" class="loginbox" style="width: 530px;">
                    ...
                    <li class="inp pad "><a class="clrblue" href="javascript:;">忘记账号或密码请拨打客服电话400-160-1717</a>
                    </li>
                    <li class="inp pad mag">
                        <a style=" width: 134px;" class="reg_btn submitBtn" href="javascript:void(0);" id="_a_loginForm">绑定账号</a>
                    </li>
                    <li class="inp pad mag"><a style=" width: 214px; font-size: 14px; padding: 12px 0;" id="forback" class="reg_btn reg_btn_well reg_btn_green" href="<#if dataKey??>/signup/index.vpage?dataKey=${dataKey?html}<#else>/signup/index.vpage</#if>">完善个人信息</a></li>
                </ul>
            </form>
            <div class="clear"></div>
        </div>
