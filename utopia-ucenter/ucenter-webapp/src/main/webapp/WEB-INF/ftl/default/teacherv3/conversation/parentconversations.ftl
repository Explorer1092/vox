...
<#--<#if pagination?? && pagination.totalPages gt 0>-->
    ...
    <#--<div id="infobox_${conversation.letterId!}" <#if (conversation_index%2 == 0)>class="t-notice-box-back"</#if>>-->
        <#--<div class="t-notice-box" >-->
            <#--<div class="tn-del w-fl-left">-->
                <#--<div class="avatar">-->
                    ...
                    <#--<i class="tn-icon tn-icon-blue"></i>-->
                <#--</div>-->
            <#--</div>-->
        ...
        <#--</div>-->
        <#--&lt;#&ndash;展开回复&ndash;&gt;-->
        <#--<div id="reply_box_${conversation.uniqueId!}" style="display: none;">-->
    ...
    <#--<div class="parent_message_page_list message_page_list" style="float:right; padding:0 0 10px;"></div>-->
    <#--&lt;#&ndash;递归查询回复&ndash;&gt;-->
    ...
    <#--<div id="reply_box_${id!}" class="entry" style="display:none; margin: 10px 20px; clear: both;">-->
        <#--<div>-->
            <#--<textarea id="reply_content_box_${id!}" style="width: 96%; height: 60px;" class="w-int"></textarea>-->
        <#--</div>-->
...
<#--<script type="text/javascript">-->
    <#--$(function () {-->
        <#--$(".parent_message_page_list").page({-->
            <#--total: ${pagination.totalPages!0},-->
            <#--current: ${currentPage!},-->
            <#--jumpCallBack: loadMessage.loadParentMessage-->
        <#--});-->
        ...
        <#--$(".send_reply_but").click(function () {-->
            ...
            <#--App.postJSON("/teacher/conversation/replyletter.vpage", {letterId: letterId, content: payload}, function (data) {-->
                <#--if (data.success) {-->
                    <#--//-->
                    <#--//更新家长留言板回复-->
                    <#--$.get('/teacher/conversation/parentconversations.vpage?currentPage=${currentPage!}', function (data) {-->
...
<#--</script>-->
<#--<#else>-->
<#--<div class="w-noData-box">您的家长留言箱没有任何内容！</span></div>-->
<div class="w-noData-box" style="line-height: initial;">
    <div class="mesg-code"></div>
    <p class="mesg-txt">手机扫码下载老师app</p>
    <p class="mesg-txt">使用家校沟通功能给家长/学生留言</p>
</div>
<#--</#if>-->