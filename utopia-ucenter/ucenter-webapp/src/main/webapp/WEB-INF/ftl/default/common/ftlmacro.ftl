...
<#macro chargeinfo name="" game="">
    <#switch name>
        ...
        <#case 'all'>
            ...
            一起作业特别提示：<#if game=="1">阿分题<#elseif game=="2">冒险岛<#elseif game=="3">走遍美国<#elseif game=="4">PICARO <#else>单词达人</#if> 不是学校布置的作业，部分内容需要付费，请自愿购买。一起作业的自有作业版块免费。
            </div>
        <#break >
    </#switch>
</#macro>
        ...
        <style type="text/css">
            ...
            <em class="serviecBtnBox">
                ...
                <a href="javascript:void(0);" style="margin:0;"
                   onclick="window.open('${ProductConfig.getMainSiteBaseUrl()}/redirector/onlinecs_new.vpage?type=teacher&question_type=question_other_pt','','width=856, height=519;');"
                   alt="老师" data-tongji="老师-在线咨询">老师请点这里</a>
            </em>
            ...
            <em class="serviecBtnBox sap">
                <em class="time">8:00-21:00在线</em>
                <a href="javascript:void(0);" style="margin:0;" onclick="window.open('${ProductConfig.getMainSiteBaseUrl()}/redirector/onlinecs_new.vpage?type=student&question_type=question_other_ps','','width=856, height=519;');" alt="学生/家长" data-tongji="学生-在线咨询">学生/家长请点这里</a>
            </em>
            <script type="text/javascript">
                $(function() {
                    var _tTime = new Date().getHours();
...
<#macro garyBeansText><#compress>
    ...
    <#if (currentUser.userType == 1)!false>
        <#if (currentTeacherDetail.isPrimarySchool())!false>园丁豆<#else>学豆</#if>
    <#else>
        <#if (currentUser.userType == 8)!false>园丁豆<#else>学豆</#if>
    </#if>
</#compress></#macro>