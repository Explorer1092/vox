                ...
                <form id="clazzFestivalInfoForm" name="info_form" enctype="multipart/form-data" action="" method="post">
                    <div class="form-horizontal">
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="clazzFestivalId" name="clazzFestivalId" class="form-control" value="${content.id!''}" style="width: 336px" disabled/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="chapterId" name="chapterId" class="form-control js-postData" type="text" value="<#if content??>${content.chapterId!''}</#if>" style="width: 336px;" disabled/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="col-sm-2 control-label">课节类型 <span style="color: red">*</span></label>
                            <div class="controls">
                                <input id="type" name="type" class="form-control js-postData" type="text" value="<#if content?? && content.type == 1>普通<#else >复习</#if>" style="width: 336px;"disabled/>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="signScore" name="signScore" class="form-control js-postData" value="<#if content??>${content.signScore!''}</#if>" style="width: 336px" disabled/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="col-sm-2 control-label">签到额外积分奖励 <span style="color: red">*</span></label>
                            <div class="controls">
                                <input type="text" id="signExtraScore" name="signExtraScore" class="form-control js-postData" value="<#if content??>${content.signExtraScore!''}</#if>" style="width: 336px" disabled/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="col-sm-2 control-label">内容模板ID <span style="color: red">*</span></label>
                            <div class="controls">
                                <input id="templateId" name="templateId" class="form-control js-postData" type="text" value="<#if content??>${content.templateId!''}</#if>" style="width: 336px;" disabled/>
                            </div>
                        </div>
                        <div class="control-group">
