...
<#-- @ftlvariable name="temporaryInfo" type="java.util.Map" -->
<#import "../../layout_default.ftl" as layout_default/>
<#import "temporaryquery.ftl" as temporaryQuery/>
<@layout_default.page page_title="CRM" page_num=3>
<div class="span9">
    <@temporaryQuery.queryPage/><br/>
    <legend>临时员工主页</legend>
...
<#--用户信息-->
    <div>
        <table class="table table-hover table-striped table-bordered">
            ...
            <tr>
                <td>${(temporaryInfo.createTime?string('yyyy-MM-dd HH:mm:ss'))!}</td>
                <td>${temporaryInfo.temporaryId!}</td>
                <td id="temporaryName_td">${temporaryInfo.temporaryName!}</td>
            </tr>
        </table>
    </div>
...
<#--用户备注-->
    <div>
        ...
        <table id="customerServiceRecord_table" class="table table-hover table-striped table-bordered">
            ...
            <#list temporaryInfo.customerServiceRecordList as record >
                <tr>
                    <td>${record.userId!""}</td>
    ...
    <div id="addRecord_dialog" class="modal hide fade">
        ...
        <div class="modal-body">
            <dl class="dl-horizontal inline">
                <dt>用户ID</dt>
                <dd>${temporaryInfo.temporaryId}</dd>
            </dl>
            <dl class="dl-horizontal inline">
                <dt>记录类型</dt>
                <dd>
...
<script>
    $(function() {
        ...
        $('#addRecord_dialog_btn').click(function() {
            ...
            var postData = {
                userId : ${temporaryInfo.temporaryId},
        ...
        $("#changeUsername_dialog_btn").on("click", function(){
            ...
            $.post(queryUrl, postData, function(data) {
                ...
                if(data.success){
                    appendNewRecord(data);
                    $("#temporaryName_td").html(data.userName);
