        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <#if teacherHomeworkHistoryList?has_content>
                <#list teacherHomeworkHistoryList as teacherHomeworkHistory>
                    <tr>
                        <td><a href="../homework/homeworkhomepage.vpage?homeworkId=${teacherHomeworkHistory.homeworkId!}&homeworkSubject=${teacherHomeworkHistory.homeworkSubject!}">${teacherHomeworkHistory.homeworkId!""}</a>
                        </td>
                        <td>
                            <a href="../user/userhomepage.vpage?userId=${userId!""}"> ${userId!""}</a>
                        </td>
                        <td>${teacherHomeworkHistory.checkTime!""}</td>
                        ...
                        <td>${teacherHomeworkHistory.bookName!""}</td>
                        ...
                        <td><a name="usedPrize" role="button"
                        ...
                        <td><a name="addIntegral" role="button" data-content-id="${teacherHomeworkHistory.homeworkId!}" class="btn btn-primary">补发园丁豆</a></td>
                    </tr>
                </#list>
            </#if>
        </table>
