...
<@layout_default.page page_title="用户注册反馈" page_num=3>
<div class="span9">
    <div>
        <form method="get" action="?" class="form-horizontal">
            <fieldset><legend>用户注册反馈</legend></fieldset>
            ...
            <#if feedbacks?has_content>
                <#list feedbacks as feedback>
                    <tr>
                        ...
                        <td>${feedback.feedback.getUserId()!''}</td>
                        <td>${feedback.feedback.getSensitiveMobile()!''}</td>
                        <td>${feedback.feedback.getVerificationCode()!''}</td>
                        <td>${feedback.feedback.getContent()!''}</td>
                        <td>
                            <#if feedback.userAuth??>
                                已绑定
                            <#else>
                                --
                            </#if>
