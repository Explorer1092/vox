...
<div id="main_container" class="span9">
    ...
    <div >
        <a class="btn btn-primary" href="/chips/ailesson/task/addform.vpage">添加-任务对话</a>
        <a class="btn btn-primary" href="/chips/ailesson/data/export.vpage?type=task">导出</a>
        <a class="btn btn-primary" href="/chips/ailesson/data/export.vpage?type=task&json=stone">导出StoneData格式</a>
                    ...
                    <#if result?? >
                        <#list result as r >
                            <tr>
                                ...
                                <td>${r.updateTime!}</td>
                                <td>
                                    <a href="/chips/ailesson/task/addform.vpage?id=${r.id!}" name="edit" data-id="${r.id!}">编辑</a>
...
<script type="text/javascript">
    $(function(){
        ...
        $("a[name=load]").click(function () {
            ...
            $.post('${requestContext.webAppContextPath}/chips/ailesson/talk/sync.vpage', {id: id, type:"task"}, function (res) {
                if (res.success) {
                    alert("加载成功");
                } else {
                    alert(res.info);
