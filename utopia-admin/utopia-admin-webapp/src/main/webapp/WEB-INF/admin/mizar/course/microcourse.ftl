...
<@layout_default.page page_title="添加/编辑微课堂列表" page_num=17>
        ...
        <form id="info_frm" name="info_frm" enctype="multipart/form-data" action="save.vpage" method="post">
            ...
            <div class="form-horizontal">
                <div class="control-group">
                    <label class="col-sm-2 control-label">课时ID<span style="font-size: 12px;color: red;">*必填</span></label>
                    <div class="controls">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="description" name="description" class="form-control input_txt" value="<#if course??>${course.description!}</#if>" />
                    </div>
                </div>
                <input name="redirectUrl" id="redirectUrl" type="hidden" value="/mizar/course/go.vpage?id=">
                <div class="control-group">
                    <label class="col-sm-2 control-label">类别</label>
                    <div class="controls">
                        <select name="category">
                            <option value="MICRO_COURSE_OPENING" <#if 'MICRO_COURSE_OPENING'==(course.category)!>selected</#if>>微课堂-公开课</option>
                            <option value="MICRO_COURSE_NORMAL" <#if 'MICRO_COURSE_NORMAL'==(course.category)!>selected</#if>>微课堂-长期课</option>
                        </select>
                    </div>
                </div>
                <#--<div class="control-group">-->
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select name="background">
                            <#list ['red','yellow','green','blue'] as bg>
                                <option value=${bg!} <#if bg==(course.background)!>selected</#if> >${bg!}</option>
                            </#list>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="controls">
                        <select name="subTitle">
                            <#list ['数学','语文','英语','才艺','家庭教育'] as tag>
                                <option value=${tag!} <#if tag==(course.subTitle)!>selected</#if> >${tag!}</option>
                            </#list>
                        </select>
                    </div>
                </div>
                ...
                <#if course??>
                    <div class="control-group">
                        <label class="col-sm-2 control-label">上传图片<span style="font-size: 12px;color: red;">*必填</span></label>
                        <div class="controls">
