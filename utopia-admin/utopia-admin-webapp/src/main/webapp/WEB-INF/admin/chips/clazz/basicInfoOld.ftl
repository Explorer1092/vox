    ...
    <div id="tableDiv" class="table-responsive table_box">
        <table class="table table-hover table-striped table-bordered" style="table-layout:fixed">
            <tr>
                ...
                <td class="wh" title="本班到课(Attendance/C)">本班到课</br>Attendance/C</td>
                <td class="wh" title="本班完课(Complete/C)">本班完课</br>Complete/C</td>
                <td class="wh" title="本班主动服务(Active/C)">本班主动服务</br>Active/C</td>
                <td class="wh" title="本班到课率(Attendance ratio/C)">本班到课率</br>Attendance ratio/C</td>
                <td class="wh" title="本班完课率(Complete ratio/C)">本班完课率</br>Complete ratio/C</td>
                <td class="wh" title="本班主动服务率(Active ratio/C)">本班主动服务率</br>Active ratio/C</td>
                <td class="wh" title="本期到课(Attendance/A)">本期到课</br>Attendance/A</td>
                <td class="wh" title="本期完课(Complete/A)">本期完课</br>Complete/A</td>
                <td class="wh" title="本期主动服务(Active/A)">本期主动服务</br>Active/A</td>
                <td class="wh" title="本期到课率(Attendance ratio/A)">本期到课率</br>Attendance ratio/A</td>
            ...
            <#if basicList?? && basicList?size gt 0>
                <#list basicList as e >
                    <tr>
                        ...
                        <td style="text-align: center">${e.attendance_c!}</td>
                        <td style="text-align: center">${e.complete_c!}</td>
                        <td style="text-align: center">${e.active_c!}</td>
                        <td style="text-align: center">${e.attendance_ratio_c!}</td>
                        <td style="text-align: center">${e.complete_ratio_c!}</td>
                        <td style="text-align: center">${e.active_ratio_c!}</td>
                        <td style="text-align: center">${e.attendance_a!}</td>
                        <td style="text-align: center">${e.complete_a!}</td>
                        <td style="text-align: center">${e.active_a!}</td>
                        <td style="text-align: center">${e.attendance_ratio_a!}</td>
                        <td style="text-align: center">${e.complete_ratio_a!}</td>
                        <td style="text-align: center">${e.active_ratio_a!}</td>
                    </tr>
                </#list>
            <#else >
                <tr>
