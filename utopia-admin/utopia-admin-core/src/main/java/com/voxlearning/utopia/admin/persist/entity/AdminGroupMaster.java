...
@DocumentTable(table = "ADMIN_GROUP_MASTER")
public class AdminGroupMaster implements Serializable {
    private static final long serialVersionUID = 7780203987168014811L;
