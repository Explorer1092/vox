 ...
 */
public class AdminOssManageUtils {

    private static final Logger logger = LoggerFactory.getLogger(AdminOssManageUtils.class);
    ...
    public static String upload(InputStream inputStream,long fileLength,String fileName, String prefix) throws Exception {
        ...
        try {
            String key = fileName+FastDateFormat.getInstance("yyyyMMddHHmmssSSS").format(new Date()) + RandomStringUtils.randomNumeric(3) + "." + prefix;
