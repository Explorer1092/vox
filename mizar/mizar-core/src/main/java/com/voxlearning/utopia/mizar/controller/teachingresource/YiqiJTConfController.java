...
import com.voxlearning.utopia.mizar.entity.yiqijt.*;
 ...
 */
@Controller
@RequestMapping("jiangxi/17JTConf")
public class YiqiJTConfController extends AbstractMizarController {
    ...
    public String courseInfo(Model model) {
        ...
        model.addAttribute("prices", YiqiJTConfCourseMapper.Price.values());
    ...
    public MapMessage saveResource(@RequestBody YiqiJTConfCourseMapper courseMapper) {
        ...
        MapMessage result;
        try {
            courseMapper.setSource(TeachingResource.SOURCE_JIANGXI); // 统一设置来源平台
            ...
            List<Integer> subjectList = Arrays.asList(101, 102, 103); // 江西版不分学科，默认语数外
