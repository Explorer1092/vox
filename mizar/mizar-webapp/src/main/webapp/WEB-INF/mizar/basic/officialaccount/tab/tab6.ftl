<div id="tab6" class="tab_con dn">
    <ul class="content clearfix">
        <li title="244">
            <div class="itembox">
                <section label="Copyright © 2015 wxbj.cn All Rights Reserved." style="border:none;border-style:none;margin: 5px auto;text-align: center;">
                    <p>
                        <img src="<@app.link href="/public/plugin/wxeditor/images/yw1.png"/>" style="margin: 0px; padding: 0px; max-width: 100%;">
                    </p>
                </section>
            </div>
        </li>
        <li title="232">
            <div class="itembox">
                <p>
                    <img src="<@app.link href="/public/plugin/wxeditor/images/yw1.gif"/>">
                </p>
            </div>
        </li>
        <li title="174">
    ...
    text-align: left;
    border-style: none;">
                    <img src="<@app.link href="/public/plugin/wxeditor/images/yw2.gif"/>" style="width: 30px; margin: 0 auto; display: inline-block;vertical-align: middle;">
                    <section style="display:inline-block;
    vertical-align: middle; font-size: 12px; margin-left:5px;">点击下方“阅读原文”查看更多内容。</section>
                </section>
            </div>
        </li>
        <li title="118">
            <div class="itembox">
                <section label="Copyright © 2015 wxbj.cn All Rights Reserved." style="border:none;border-style:none;margin: 5px auto;text-align: center;">
                    <p>
                        <img src="<@app.link href="/public/plugin/wxeditor/images/yw3.gif"/>" style="margin: 0px; padding: 0px; max-width: 100%;">
                    </p>
                </section>
            </div>
        </li>
        <li title="114">
            <div class="itembox">
                <p>
                    <img style="height: auto !important;" src="<@app.link href="/public/plugin/wxeditor/images/yw4.gif"/>">
                </p>
            </div>
        </li>
            ...
            <div class="itembox">
                <section>
                    <section label="Copyright © 2015 wxbj.cn All Rights Reserved.">
                        <section style="margin-top: -1px;margin-bottom: 0; min-height: 40px; visibility: visible; height: 40px;
    line-height: 40px; border-radius: 4px; text-align: center;box-shadow: 0px 3px 5px #BEBEBE;
    background: #eeefef;"><span style="font-size:14px;color: #6e6d6d;"><span style="float: left;margin-left:10px;font-size: 24px;">↙</span> 点击下方“阅读原文”查看更多</span>
                        </section>
                    </section>
                </section>
            </div>
