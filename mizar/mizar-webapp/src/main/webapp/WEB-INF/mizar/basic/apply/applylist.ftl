...
<div class="op-wrapper orders-wrapper clearfix">
    <form id="filter-form" action="/basic/apply/index.vpage" method="get">
        <#--<div class="item">-->
            <#--<p>申请人</p>-->
            ...
            <tbody>
                <#list page as item>
                    <#switch (item.entityType)!>
                        <#case "brand">
                            <#assign entityName = "品牌"/>
                            <#break />
                        <#case "shop">
                            <#assign entityName = "机构"/>
                            <#break />
                        <#case "goods">
                            <#assign entityName = "课程"/>
                            <#break />
                        <#case "family_activity">
                            <#assign entityName = "亲子活动"/>
                            <#break />
                    </#switch>
                <tr>
                    ...
                    <td>${displayHtml!''}</td>
                    <td>
                        <a class="op-btn ${opType}" data-link="/basic/apply/changedetail.vpage?id=${item.id!}" href="javascript:void(0);">查看详情</a>
                    </td>
                </tr>
                </#list>
            </tbody>
