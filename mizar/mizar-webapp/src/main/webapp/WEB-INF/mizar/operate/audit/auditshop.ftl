...
<div class="bread-nav">
    ...
    &gt;
    <a class="current-dir" href="javascript:void(0);" style="cursor: default">机构变更审核</a>
</div>
...
<div>
    ...
    <div style="float:left; width: 300px; margin-right: 20px;">
        <div class="input-control">
            ...
            <span>
                <#if ((analysis["brandId"].diff)!false)>
                ${(analysis["brandId"].after)!"新增机构"}
                    <#if (analysis["brandId"].before)?has_content>
                        <i class="old" title="${(analysis["brandId"].before)!""}">旧</i><#else><i class="new">新</i>
                    </#if>
                <#else>
                ${(analysis["brandId"].before)!""}
                </#if>
            </span>
            ...
            <label>
                ...
                <#if (analysis["photo"].diff)!false>
                    <#if (analysis["photo"].before)?has_content>
                        <a class="detailHistoryBtn" data-detail="${(analysis["photo"].before)!?join(',')}" href="javascript:void (0);" style="color: #00b7ee">查看历史</a>
                    </#if>
                </#if>
            </label>
