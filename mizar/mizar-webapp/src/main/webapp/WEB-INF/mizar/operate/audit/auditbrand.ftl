...
<div class="bread-nav">
    ...
    &gt;
    <a class="current-dir" href="javascript:void(0);" style="cursor: default">品牌变更审核</a>
</div>
<h3 class="h3-title">
    品牌变更审核
</h3>
<div>
    <input  type="hidden" id="rid"  name="rid" <#if (record.id)??>value="${record.id!}"</#if> >
            ...
            <label>
                ...
                <#if (analysis["brandLogo"].diff)!false>
                    <#if (analysis["brandLogo"].before)?has_content>
                        <a class="detailHistoryBtn" data-detail="${(analysis["brandLogo"].before)!''}" href="javascript:void (0);" style="color: #00b7ee">查看历史</a>
                    </#if>
                </#if>
            </label>
            ...
            <label>
                ...
                <#if (analysis["brandPhoto"].diff)!false>
                    <#if (analysis["brandPhoto"].before)?has_content>
                        <a class="detailHistoryBtn" data-detail="${(analysis["brandPhoto"].before)!?join(',')}" href="javascript:void (0);" style="color: #00b7ee">查看历史</a>
                    </#if>
                </#if>
            </label>
            <div class="image-preview clearfix">
            ...
            <label>
                ...
                <#if (analysis["certificationPhotos"].diff)!false>
                    <#if (analysis["certificationPhotos"].before)?has_content>
                        <a class="detailHistoryBtn" data-detail="${(analysis["certificationPhotos"].before)!?join(',')}" href="javascript:void (0);" style="color: #00b7ee">查看历史</a>
                    </#if>
                </#if>
            </label>
            <div class="image-preview clearfix">
