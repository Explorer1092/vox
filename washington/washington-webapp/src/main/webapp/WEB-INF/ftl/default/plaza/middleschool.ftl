            ...
            <div id="signup_form_box" class="loginbox">
                ...
                <ul>
                    ...
                    <li class="inp codeinfo">
                        ...
                        <input id="captchaCode" value="" class="require" name="verificationCode" type="text" data-label="验证码" data-role="teacher" style="width: 80px;" maxlength="6"/>
                    ...
                    <li class="inp txt pad" style="padding: 0 0 0 75px !important;">
                        ...
                        <a class="clrblue" title="用户协议" href="/help/agreement.vpage" target="_blank">《一起作业用户协议》</a>
                        <span class="hint"></span>
                    </li>
...
<script type="text/javascript">
    ...
    $(function () {
        $("#download_userinfo_but").click(function(){
            $(this).attr("href","/clazz/fetchaccount.vpage");
        });
