<#--概念说一说-->
<script id="t:VOICE_OBJECTIVE" type="text/html">
    <div class="w-base" style="border: 0;">
        ...
        <div class="w-base examTopicBox" style="margin:15px;">
            ...
            <div class="homeworkBox">
                <div>
                    <ko-venus-question params="questions:$root.getQuestion($data.questionId()),contentId:'subjective_' + $index(),formulaContainer:'tabContent'"></ko-venus-question>
                </div>
