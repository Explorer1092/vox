...
pageCssFile={"css" : ["public/skin/project/ctepackage/pc/css/skin"]}
>
<#include "../../../layout/project.header.ftl"/>

<div style="padding: 150px 0; font-size: 16px; text-align: center;">活动已下线</div>
<#--<div class="autTeaPacks-box">
    <div class="autTea-inner">
        <div class="autTea-banner" style="background-position: 0 -1px;"></div>
        <div class="aut-bg">
            ...
            <#else>
                ...
                <div class="autTea-side">方便收货时间：
                    <input type="text" class="txt JS-datetimeInput" placeholder="例如：10月10日上午-10月31日下午"/>（送货时间：10月10日-31日）
                </div>
                ...
                <div class="autTea-btn" style="margin: 30px 0;">
