                ...
                <#if paper??>
                    <div class="listen-box">
                        ...
                        <div class="listen-list">
                            <#if (paper.questions)?has_content>
                                    ...
                                    <p>
                                        <#if question.tipSentence??>
                                            <li class="tts_li_play" id="${question.tipSentence.voice!}">
                                                            <span style="width:729px;display: inline-block">
                                                            ${question.tipSentence.content!}
                                                            </span>
                                                <input type="button" class="lis_step1_play tts_play" value="播放" style="position: absolute;right: 0;bottom: 10px;"/>
                                            </li>
                                        </#if>
                                        </p>
                                    </div>
                                                    ...
                                                    <#list subQuestion.sentences as sentence>
                                                        <#if sentence??>
                                                            <li class="tts_li_play" id="${sentence.voice!}">
                                                                        <div style="width:729px;display: inline-block" class="text">
