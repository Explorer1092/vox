<table width="100%" border="0" cellspacing="0" cellpadding="0" xmlns="http://www.w3.org/1999/html">
<#list map_top_list as map>
    <#if map_index % 2 == 0>
    <tr>
    </#if>
    <#--<#if map_index % 2 != 0>
        <td width="1%" rowspan="2" valign="top" style=" font-size:14px; font-weight:bold; padding: 0 0 20px"><img
                src="http://www.17zuoye.com/public/app/default/images/list_mid.png"></td>
    </#if>-->
    <td valign="top" width="50%" style=" font-size:14px; font-weight:bold; padding: 0 0 30px">
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td width="1%" align="right"><#--<img src="http://www.17zuoye.com/public/app/default/images/logo_small.png">-->
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2">请打开网址,输入学号和密码登录，<div>并完成老师布置的作业</div></td>
            </tr>
        </table>
    </td>
    ...
    <#if map_index % 2 != 0>
        ...
        <tr>
            <td valign="top" style=" font-size:14px; font-weight:bold; "><img
                    src="http://www.17zuoye.com/public/app/default/images/list_bot.png" width="293" height="32"></td>
            <td valign="top" style=" font-size:14px; font-weight:bold; "><img
                    src="http://www.17zuoye.com/public/app/default/images/list_bot.png" width="293" height="32"></td>
        </tr>
    </#if>
