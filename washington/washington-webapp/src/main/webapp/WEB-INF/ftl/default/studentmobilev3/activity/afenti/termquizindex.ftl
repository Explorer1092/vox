...
<div class="te-listBox">
    <a href="javascript:void(0);" data-bind="click: contentBtn.bind($data,'math')" class="te-list">
    ...
    <a href="javascript:void(0);" data-bind="click: contentBtn.bind($data,'english')" class="te-list">
    ...
    <a href="javascript:void(0);" data-bind="click: contentBtn.bind($data,'chinese')" class="te-list">
