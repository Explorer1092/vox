...
<@temp.page header="false" title="教师联盟，邀请有礼">
    <@app.css href="public/skin/project/inivteenglishteacher/css/invitegifts.css"/>
    <@sugar.capsule js=[ "alert","voxLogs","ko","englishteacherleague"]/>
<style>
    body{
        background: #7ad7dd;
    }
...
<div class="wrapper">
    <div class="s-banner-2">
        <img src="<@app.link href='public/skin/project/inivteenglishteacher/images/banner-v2.jpg'/>" alt="">
    </div>
    <div class="g-section">
        <div class="item-box">
            <div class="item-list">
        ...
        <div class="item-box">
            <div class="item-list">
                <h3>奖励规则</h3>
                <div class="context">
                    <div class="prompt-txt" style="line-height: 1.5em;">邀请初中英语新老师，30天内双方达成认证，双方各得20元布置作业流量费！</div>
                    <div class="prompt-txt" style="line-height: 1.5em;">被邀请人达成认证时邀请人已认证，双方将在72小时内获得奖励；</div>
                    <div class="prompt-txt" style="line-height: 1.5em;">被邀请人达成认证时邀请人未认证，邀请人达成认证后72小时内获得奖励。</div>
                    <div>
                        <div class="t-tit">注意事项</div>
                        <p class="txt"><i>1.</i>活动下线时间为2018年6月30日24:00，在2018年6月30日发出的邀请，最晚可以在2018年7月30日前完成任务。</p>
                        <p class="txt"><i>2.</i>邀请双方老师必须在被邀请老师注册后30天内完成认证，如未满足要求，无法获得奖励。</p>
                        <p class="txt"><i>3.</i>被邀请老师必须是初中英语老师。</p>
                    </div>
                </div>
        ...
        <div class="item-box">
            <div class="item-list">
                ...
                <div class="to-auth" data-bind="visible: authenticate() == 'SUCCESS'" style="display:none;"><span>您已邀请了<!--ko text:invitedTeacherNum--><!--/ko-->名老师，累计获得流量<!--ko text:totalAwardNum--><!--/ko-->元！</span></div>
    ...
    <script type="text/html" id="alertDialog">
        <div class="m-popup">
            ...
            <div class="popIner">
                ...
                <div class="context">
                    <p>1、设置姓名并绑定手机</p>
                    <p>2、至少8名学生，每人完成过3次作业</p>
                    <p>3、至少3名学生，每人绑定了手机</p>
