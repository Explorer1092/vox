...
<head>
    ...
    <title>智康1对1</title>
    <@sugar.capsule js=["jquery", "core", "alert", "template"] css=["plugin.alert", "specialskin", "project.jiajiaobang"] />
...
<script type="text/javascript">
    $(function(){
        ...
        /*进入确定*/
        if(!$17.getCookieWithDefault("zhikang")){
            $17.setCookieOneDay("zhikang", "1", 1);
                    ...
                    $("#okBtn").on("click",function(){
                        $.post("/reward/order/exchangedcoupon.vpage", {
                            ...
                            if(data.success){
                                ...
                                $17.tongji('智康1对1-报名成功');
                                if($17.isBlank(mobileCode.val())){
                                    YQ.voxLogs({module : 'coupon', op : 'zhikang_submit', userId : '${(currentUser.id)!''}'},'student');
                                }else{
                                    YQ.voxLogs({module : 'coupon', op : 'zhikang_bind_submit', userId : '${(currentUser.id)!''}'},'student');
                                }
        ...
        $('#getVerifyCode').on("click", function(){
            ...
            //统计-点击绑定手机号按钮的点击数
            YQ.voxLogs({module : 'coupon', op : 'zhikang_bind', userId : '${(currentUser.id)!''}'},'student');
