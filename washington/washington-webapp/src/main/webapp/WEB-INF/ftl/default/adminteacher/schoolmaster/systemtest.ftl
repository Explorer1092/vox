...
pageJsFile={"systemtest": "public/script/adminteacher/schoolmaster/systemtest"}
                        ...
                        <div class="contentMain">
                            <div class="section">
                                <div class="selectWrap selectWrap02">
                                    ...
                                    <div class="selList" data-bind="visible: subjectList().length" style="display: none;">
