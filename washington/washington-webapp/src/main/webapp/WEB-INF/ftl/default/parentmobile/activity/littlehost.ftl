...
<div class="sopcast-banner"></div>
    ...
    <div class="sopcast-code">
        ...
        <div class="code">
            <img src="/public/skin/parentMobile/images/activity/sopcast/qrcode.png">
        </div>
    </div>
    </#if>
...
<div class="sopcast-main sopcast-main02">
    ...
    <div class="sc-base sc-white">
        <div class="title sc-yellow">
            <span class="fl">7.10 上午 10:00-11:30</span>
            <span class="fr">公开课</span>
        </div>
        <div class="textBox">
            <div class="sc-text">
                <p class="small">内容</p>
...
<div class="sopcast-main sopcast-main03">
    <div class="tag">报名方法</div>
    <div class="sc-base sc-white">
        <div class="textBox">
            <div class="sc-text">
                <p>现在预约试听『公开课』，仅需<span class="text-red">1.7元</span>，快来体验吧。<br>加入我们，一起打造专属宝贝的美食节目！</p>
            </div>
            <div class="sc-text">说明: 1.7元仅是公开课费用，正式课5节原价200元，活动期间优惠价<span class="text-red">150元</span>。家长可以在试听公开课后，根据孩子兴趣，决定是否购买课程</div>
        </div>
    </div>
</div>
<#if !(hasPaid!false)>
<div class="sopcast-footer">
    <div class="empty"></div>
    <div class="sc-btns">
            <div class="btns"><a id="js_buy" class="js-submitBtn" data-type="${trusteeType!0}" data-sid="${studentId!0}" href="javascript:void(0)"><span>￥</span>1.7元，预约试听吧 </a></div>
    </div>
    </#if>
<script type="text/javascript">
    ...
    //公开课活动页页面加载打点
    YQ.voxLogs({database : "parent", module : 'm_eIEsMv6Q', op : 'o_RmtSI9gS', s0 : getQuery("s0")});
    //公开课活动页付款按钮点击打点
    $("#js_buy").on("click",function(){
        YQ.voxLogs({database : "parent",module:"m_eIEsMv6Q",op:"o_lWFfHXR5"});
    });
</script>
</@layout.page>