<script id="t:INTELLIGENT_TEACHING" type="text/html">
    ...
    loadExamImg:$root.loadExamImg.bind($root),viewCourse:$root.viewCourse.bind($root),addOrRemoveSmallPackage:$root.addOrRemoveSmallPackage.bind($root)}"></intelligent-teaching-smallpackage>
    <!--/ko-->
        ...
        <div class="seth-mn">
            <div class="testPaper-info">
                <div class="inner">
                    ...
                    <div class="box" data-bind="attr:{id : 'qc' + $parentContext.$index() +  '_' + $index()}"></div>
                    <div data-bind="text:$parent.loadExamImg(question.id(),$index(),'#qc' + $parentContext.$index() +  '_' + $index())"></div>
                    <!--/ko-->
                    <ul class="h-analysis-box2">
                        ...
                        <li class="postInfo lastChild">
                            ...
                            <div class="context" data-bind="foreach:{data:postQuestions(),as:'postQuestion'}">
                                <div class="box" data-bind="attr:{id : 'pc' + $parentContext.$index() + '_' + $index()}"></div>
                                <div data-bind="text:$parent.loadExamImg(postQuestion.id(),$index(),'#pc' + $parentContext.$index() + '_' + $index())"></div>
                            </div>
                            <!--/ko-->
                            <i class="tagIcon"></i>
                        </li>
