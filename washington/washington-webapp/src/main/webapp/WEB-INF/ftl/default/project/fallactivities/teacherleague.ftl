...
<@sugar.capsule js=[ "alert","voxLogs","ko","teacherleague"]/>
<style>
    body{
        background: #7ad7dd;
    }
...
<div class="wrapper">
    <div class="s-banner-2">
        <img src="<@app.link href='public/skin/project/fallactivities/images/banner_07-v3.jpg'/>" alt="">
    </div>
    <div class="g-section">
        <div class="item-box">
            <div class="item-list">
        ...
        <div class="item-box">
            ...
            <div class="item-list">
                <h3>奖励规则</h3>
                <div class="context">
                    <div class="prompt-txt" style="line-height: 1.5em;">邀请数学新老师，30天内双方达成认证，双方各得20元布置作业流量费！</div>
                    ...
                    <div>
                        ...
                        <p class="txt"><i>1.</i>活动下线时间为2018年6月30日24点，在2018年4月30日发出的邀请，最晚可以在2018年7月30日完成任务。</p>
                        <p class="txt"><i>2.</i>邀请双方老师必须在被邀请老师注册后30天内完成认证，如未满足要求，无法获得奖励。</p>
                        <p class="txt"><i>3.</i>被邀请老师必须是小学数学老师。</p>
                    </div>
                </div>
