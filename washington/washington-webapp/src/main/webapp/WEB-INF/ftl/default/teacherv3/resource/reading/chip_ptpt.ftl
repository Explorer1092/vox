...
<dl class="horizontal_vox" style="padding-left: 20px;">
    <dt><span class="text_red">[必填] </span>上传图片：</dt>
    <dd>
        <input class="int_vox" style="margin:0 10px;" value="<%= image_two %>">
        <span id="image_upload_two" data-userid="${currentUser.id}" data-uploadimageurl="${uploadfile!}" style="vertical-align: -16px;"></span>
    </dd>
</dl>
<div class="line_show"></div>
