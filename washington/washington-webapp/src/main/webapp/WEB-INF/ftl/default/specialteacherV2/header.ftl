<div id="page_hd">
    <div class="page_hd">
        ...
        <#if currentUser.id?has_content>
            <li class="mark_exam JS-markExam" style="display: none;">
                <#--主站url中含有test.17zuoye.net，根据环境设置跳转链接-->
                <#if "${((ProductConfig.getMainSiteBaseUrl())!'')?contains('test.17zuoye')?string}" == "true">
                <a href="http://zx-math.test.17zuoye.net/chemistry/exam/list">
                    <i class="mark_icon"></i>考试阅卷
                </a>
                <#else>
                <a href="https://zx-math.17zuoye.com/chemistry/exam/list">
                    <i class="mark_icon"></i>考试阅卷
                </a>
                </#if>
            </li>
            <li class="user_message" style="display: none;">
            ...
            <li class="has_sub v-menu-hover">
                ...
                <ul class="sub_nav select" style="left: inherit; right: 0px; width: 83px;">
                    <li><a href="/specialteacher/center/index.vpage" class="">个人中心</a></li>
...
<script type="text/javascript">
    signRunScript = function () {
        ...
        // 判断教务老师是否是管理员，显示header考试阅卷入口
        $.ajax({
            url: '/specialteacher/judgeexammanager.vpage',
            type: 'GET',
