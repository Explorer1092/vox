...
<script type="text/javascript">
    ...
    var init = function(){
        ...
        var flashAndFrameWidth = 700; //flash and frame width
        var flashAndFrameHeight = 470; //flash and frame height
        ...
        if(gameSize == "B"){
            //set flash 宽高手度
            flashAndFrameWidth = 900;
            flashAndFrameHeight = 600;
        ...
        if(gameSize == "C"){
            //set flash 宽高手度
            flashAndFrameWidth = 960;
            flashAndFrameHeight = 643;
            //set frame 弹出框 class控制宽度
