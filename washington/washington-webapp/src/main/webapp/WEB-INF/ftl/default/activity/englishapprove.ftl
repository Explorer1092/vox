...
pageJsFile={"newstudapprove" : "public/script/project/englishapprove"}
...
<div class="kj-wrap" data-bind="visible: isLoaded" style="display:none;">
    ...
    <div data-bind="visible: isShowProg" style="display: none;">
        ...
        <div class="stateBox">
            <p>说明：</p>
            <p>1. 新学生数是指：初中英语老师认证后，在活动期间完成3次以上英语作业的新学生数。本次活动前完成过3次以上英语作业的学生不包括在内</p>
    ...
    <div class="popInner">
        ...
        <div class="popMain">
            ...
            <div class="txt">
                ...
                <p>参加活动前认证的老师，在参加活动30天内达到有效条件既有效</p>
                <p>参加活动后认证的老师，在认证后30天内达到有效条件既有效</p>
            </div>
            <div class="txt">
                <p class="title">作业条件：</p>
                <p>学生一天之内完成多份作业只计算1次，不包括绘本作业及补做</p>
            </div>
            <div class="txt">
            ...
            <div class="txt">
                <p class="title">排行特殊说明：</p>
                <p>如遇并列，则按参与活动时间先后排序（即点击“参与活动”按钮）</p>
            </div>
            <div class="txt">
                <p class="title">奖励特殊说明：</p>
                <p>不同学校的奖励设置略有不同，具体以老师在平台活动页所见为准；如老师在活动期间发生转校行为，将按照参与活动时的学校奖励设置进行发放</p>
            </div>
...
<script type="text/html" id="T:activStudNum">
    <p class="details">认证老师名下的，在领奖有效期间内新注册且累计完成3次英语作业的学生人数分别达到
        <!-- ko if:schoolLevel == 'S' -->
        25/50/75，可累计获得30/60/90
        <!--/ko-->
        <!-- ko if:schoolLevel == 'A' -->
        25/50/75，可累计获得30/60/90
        <!--/ko-->
        <!-- ko if:schoolLevel == 'B' -->
        30/60/90，可累计获得30/60/90
        <!--/ko-->
        元流量奖励
    </p>
</script>
