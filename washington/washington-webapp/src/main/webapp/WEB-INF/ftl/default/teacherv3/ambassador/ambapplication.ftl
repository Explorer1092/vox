...
<@temp.page showNav="hide">
    ...
    <div class="m-main" style="padding-top: 15px;">
        ...
        <#if true>
            ...
            <div class="apply-box">
                <!--什么是校园大使-->
                <div class="ab01 mc-box">
                    <div class="ab-hd mc-hd">
                        <p>什么是校园大使</p>
                    </div>
                    <div class="ab-mn mc-mn">
                        <div class="inner-box">
                            <p>校园大使是一起作业在本校的代言人，为老师和学生们提供服务，传播教育理念!</p>
                            <div class="w-ag-center">
                                <a href="javascript:void(0);" class="w-btn w-btn-small v-clickDetailAmbFl" style="width: 220px;">点击查看大使职责和福利</a>
                            </div>
                        </div>
                    </div>
                </div>
                <!--申请成为预备大使-->
                <div class="ab02 mc-box">
                    <div class="ab-hd mc-hd">
                        <p>什么是预备大使</p>
                    </div>
                    <div class="ab-mn mc-mn">
                        <div class="inner-box inner-box02">
                            <div class="info">
                                <p style="margin-bottom: 5px;">在本科目存在正式校园大使时，您可以申请成为『预备大使』，当现任大使不作为或辞任时，优先上任。</p>
                                <p>1. 认证老师（<#if (currentUser.fetchCertificationState() == "SUCCESS")!false><span class="txt-red">您已经是认证老师，满足条件</span><#else><span class="txt-red">您还不是认证老师</span>，<a href="${(ProductConfig.getUcenterUrl())!''}/teacher/center/index.vpage#/teacher/center/myauthenticate.vpage" target="_blank" class="txt-link">看看如何认证</a></#if>）</p>
                                <#--<p>2. 教师等级在LV2及以上（<span class="txt-red">您目前的等级是LV${(currentUser.level)!0}，<#if (currentUser.level gte 2)!false>满足条件<#else><a href="${(ProductConfig.getUcenterUrl())!''}/teacher/center/index.vpage#/teacher/center/mylevel.vpage" target="_blank" class="txt-link">看看如何升级</a></#if></span>）</p>-->
                                <p>3. 任期内大使不作为或辞任，经官方审核，申请者中<a href="javascript:void(0);" class="txt-link v-clickLlValue">【努力值】</a>最高者当选  </p>
                            </div>
                            <div class="w-ag-center">
                                ...
                                <#if (currentUser.fetchCertificationState() == "SUCCESS")!false>
                                    <a href="javascript:void(0);" class="w-btn w-btn-small v-clickCompetitionBtn">我要申请</a>
                                <#else>
                                    <a href="javascript:void(0);" class="w-btn w-btn-small v-clickNotSign">我要申请</a>
                                </#if>
                            </div>
                        </div>
                    </div>
...
//                                    if(!$17.isCnString(data.name)){
                                    ...
                                    if($17.isBlank(data.bMonth)){
                                        alertInfo("请选择生日", function(){ $("input[name='birthday']").focus(); });
                                        return false;
                                    }
                                    ...
                                    $.post("/ambassador/schoolambassador.vpage", data, function(data){
                                        if(data.success){
                                            $.post("/ambassador/joincompetition.vpage", {}, function(data){
                                                if(data.success){
                                                    $17.alert("恭喜您已成为预备大使！", function(){
