...
<div class="m-main" id="reportList">
    <div class="h-homeworkCorrect">
        <h4 class="link">
            <a href="javascript:void(0);" data-bind="attr:{href:'/teacher/newexam/report/index.vpage?subject=' + $root.subject()}">我的测试</a>&gt;<span>测试详情</span>
        </h4>
        <div class="w-base" style="padding-bottom:5px;">
            ...
            <div class="t-del-homework" style="display: none;" data-bind="if:!prLoading(),visible:!prLoading()">
                ...
                <p data-bind="if:examNeedCorrect,visible:examNeedCorrect">批改时间：<span data-bind="text:examStopAt() + ' 至 ' + correctStopAt()"></span></p>
            </div>
            ...
            <div style="display: none;" data-bind="if:focusTab() == 'student',visible:focusTab() == 'student' && !prLoading()" class="w-table t-del-homework">
                <table>
                    ...
                    <tr data-bind="css:{'odd':$index()%2 == 0}">
                        ...
                        <!--/ko-->
                        <td>
                            <a target="_blank" data-bind="attr:{href:'/teacher/newexam/report/studentanswer.vpage?userId=' + student.userId + '&newexamId=' + $root.newExamId}">查看</a>
                        </td>
                    </tr>
                    <!--/ko-->
                    <!--/ko-->
...
<@sugar.capsule js=["newexam.detail"]/>
...
<script type="text/javascript">
    $(function(){
        var clazzId = $17.getQuery("clazzId")
            ,newExamId = $17.getQuery("newExamId")
            ,initExamSuccess = false;
        if(!clazzId || !newExamId){
            $17.alert("地址参数信息不全",function(){
                window.location.href = "/teacher/newexam/report/index.vpage";
            });
        }
