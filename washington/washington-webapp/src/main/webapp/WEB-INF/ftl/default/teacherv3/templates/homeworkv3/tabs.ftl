<#macro tabTemplate subject="">
    ...
    <#switch subject>
        <#case "ENGLISH">
            ...
            <#include "naturalspelling.ftl">
            <#include "dubbing.ftl">
            <#include "english/intelligentteaching.ftl">
            <#include "../homeworkv5/english/oralcommunication.ftl">
            <#include "../homeworkv5/english/dictation.ftl">
            <#break >
        <#case "MATH">
            <#include "mental.ftl">
            <#include "keypoints.ftl">
            <#include "math/intelligentteaching.ftl">
            <#include "math/ocrmentalarithmetic.ftl">
            <#include "math/calcintelligentteaching.ftl">
            <#break >
        <#case "CHINESE">
            <#include "newreadrecite.ftl">
            <#include "readrecitewithscore.ftl">
            <#include "wordrecognitionandreading.ftl">
            <#include "../homeworkv5/chinese/wordteachandpractice.ftl">
            <#break >
    </#switch>
