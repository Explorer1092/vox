...
pageJsFile={"newstudapprove" : "public/script/project/activityapprove"}
...
<div class="kj-wrap" data-bind="visible: isLoaded" style="display:none;">
    <div class="headerBox">
        <div class="banner bannerenglish"></div>
        <i class="handIcon"></i>
        <!--活动规则入口-->
    ...
    <div data-bind="visible: isShowProg" style="display: none;">
        ...
        <div class="stateBox">
            <p>说明：</p>
            <p>1. 新学生数是指：<!--ko text:activityNote--><!--/ko-->老师认证后，在活动期间完成3次以上<!--ko text:activityNote--><!--/ko-->作业的新学生数。本次活动前完成过3次以上<!--ko text:activityNote--><!--/ko-->的学生不包括在内</p>
    ...
    <div class="popInner">
        ...
        <div class="popMain">
            <div class="txt">
                ...
                <p data-bind="text:activityTime"></p>
            </div>
            <div class="txt">
                <p class="title">活动对象：</p>
                <p><!--ko text:activityperiod--><!--/ko--><!--ko text:activityNote--><!--/ko-->老师</p>
            </div>
            <div class="txt">
            ...
            <div class="txt">
                ...
                <p>参与活动时已认证的老师，在活动结束前达到条件即有效</p>
                <p>参与活动时未认证的老师，在活动结束前认证，认证后最晚不超过<!--ko text: endTime --><!--/ko-->达到条件即有效</p>
            </div>
            <div class="txt">
...
<script type="text/html" id="T:activStudNum">
    <p class="details">认证老师名下的，在领奖有效期间内新注册且累计完成3次<!--ko text:$root.activityNote--><!--/ko-->作业的学生人数分别达到
        <!-- ko if:$root.activityId() == '120001' -->
            <!-- ko if:schoolLevel == 'A' -->
            20/30/60人，可累计获得30/60/90
            <!--/ko-->
            <!-- ko if:schoolLevel == 'B' -->
