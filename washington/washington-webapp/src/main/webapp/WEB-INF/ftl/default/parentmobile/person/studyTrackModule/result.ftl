        ...
        <div class="parentApp-pathSection">
            ...
            <div class="parentApp-pathContent">
                ...
                <#else>
                    ...
                    <div class="parentApp-pathCanvas"  style=" overflow: visible; -webkit-transform: translateZ(0);">
                        <#if rankInfo.subjectDisplay == "数学">
                            <#if mathDiff gt 0>
                            ...
                            <ul class="list">
                                ...
                                <#if mathDiff gt 0>
                                    <li class="green">本周成绩趋势提高${mathDiff}分</li>
                                <#elseif mathDiff == 0>
                                    <li class="yellow">本周数学成绩与上周持平，请继续加油！</li>
                                <#else>
                                    <li class="red">本周成绩趋势降低${(mathDiff)?abs}分</li>
                                </#if>
                            </ul>
                        <#elseif rankInfo.subjectDisplay == "英语">
                            <canvas class="${rankInfo.polarAreaClass}" style="width: 40%;"></canvas>
                            <ul class="list">
                        ...
                        <div class="text">${getChartDisplay(rankInfo.subjectDisplay)}</div>
                    </div>
                </#if>
            </div>
        </div>
