    ...
    <dl>
        ...
        <dd>
            <div class="w-border-list t-homeworkClass-list">
                <ul>
                    <li data-tablevel="7" class="v-level">七年级</li>
                    <li data-tablevel="8" class="v-level">八年级</li>
                    <li data-tablevel="9" class="v-level">九年级</li>
                </ul>
            </div>
        </dd>
    </dl>
</div>
<div class="v-book-list w-border-list t-teachingMaterial" style="max-height: 520px; overflow-y: scroll;">
    <ul id="search_book_list_7" data-books="7" class="bookListBox" style="display: none;"></ul>
    <ul id="search_book_list_8" data-books="8" class="bookListBox" style="display: none;"></ul>
    <ul id="search_book_list_9" data-books="9" class="bookListBox" style="display: none;"></ul>
</div>
