...
<script type="text/html" id="OCR_DICTATION">
    ...
    <div class="h-set-homework">
        <div class="seth-mn">
            <iframe class="vox17zuoyeIframe" data-bind="attr:{src: domain + '/resources/apps/hwh5/homework-apps/student-app-exam/v2.5.0/ocr-dictation/result.html?' + extraParams}" src="" width="375" marginwidth="0" height="812" marginheight="0" scrolling="no" frameborder="0"></iframe>
        </div>
    </div>
</script>
...
<script type="text/javascript">
    ...
    <@sugar.capsule js=["ko",'homework2nd',"jplayer","chinese.recognitionreadingquestion","homeworkv3.studentreportdetail"] />
</@shell.page>