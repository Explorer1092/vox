...
<script type="text/html" id="NEW_READ_RECITE">
    ...
    <div class="read-aDetails">
        ...
        <div class="aDetails-section">
            ...
            <div class="r-inner" data-bind="css:{'showDetails':$root.showParagraphId() == (lesson.questionBoxId + '_' + $index())}">
                <div class="readTxt-list">
                    <div class="frAside">
                        <span class="playIcon voicePlayer" data-bind="click:$root.playAudio.bind($data,$element,$root)"></span>
                        <div style="display: inline-block;" data-bind="click:$root.showDetailBtn.bind($data,$root,lesson.questionBoxId,$index())">
...
<script type="text/html" id="ORAL_PRACTICE">
    ...
    <div class="h-answerD-list">
        <div class="hd">
            <div class="box" data-bind="if:$root.questionLoading && !$root.questionLoading(),visible:$root.questionLoading && !$root.questionLoading()">
                <ko-venus-question params="questions:$root.getQuestion(questionDetail.qid),contentId:'preExamImg-' + $index(),formulaContainer:'tabContentHolder'"></ko-venus-question>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    <@sugar.capsule js=["ko","jplayer","chinese.recognitionreadingquestion","studentreport.detailv5"] />
</@temp.page>
