...
<@com.page menuIndex=21 menuType="normal">
...
<#if false>
<div>
    <div class="paperStep" style="font-size: 16px;">
        网站优化中，暂不能提供组卷功能，预计将在九月中下旬开放，谢谢您的理解和支持！
    </div>
</div>
<#else>
<div>
    ...
    <#--课本年级分类-->
        <div id="selectGradeBook" style="display: none;">
            <ul class="container_tab">
                <li data-tablevel="1" class=""><a href="javascript:void(0);"><strong>一年级</strong></a></li>
                <li data-tablevel="2" class=""><a href="javascript:void(0);"><strong>二年级</strong></a></li>
...
<script id="t:书本模板" type="text/html">
    ...
    <li class="v-book" data-bookid="<%=rows[i].id%>">
        <div class="icon_general icon_general_30 t-select-icon"></div>
        <dl class="w-imageText-list">
            <dt>
        ...
        init : function(){
            ...
            $this.liBook.die().live({
                click: function(){
                    ...
                    var delBooks = function(){
                        ...
                        $("#addClazzBook").find("li[data-bookid=" + $self.data("bookid") + "]").find("div.icon_general").attr("class","icon_general icon_general_30 t-select-icon").hide();
            ...
            $("#cancelBook").die().live("click",function(){
                $.each($this.bookIds,function(index){
                    $("#addClazzBook").find("li.v-book").find("div.icon_general").attr("class","icon_general icon_general_30 t-select-icon").hide();
