        ...
        <div class="seth-mn">
            <div class="testPaper-info">
                <div class="inner">
                    ...
                    <div data-bind="text:$root.loadExamImg(question.id(),$index(),'#mathExamImg'+ $index())"></div>
                    <ul class="h-analysis-box">
                        ...
                        <li class="postInfo lastChild">
                            ...
                            <div class="context" data-bind="foreach:{data:question.postQuestions(),as:'postQuestion'}">
                                <div class="box" data-bind="attr:{id : 'mathExamImg_post' + $parentContext.$index() + $index()}"></div>
                                <div data-bind="text:$root.loadExamImg(postQuestion.id(),$index(),'mathExamImg_post' + $parentContext.$index() + $index())"></div>
                            </div>
                            <i class="tagIcon"></i>
                        </li>
                    </ul>
                ...
                <div class="linkGroup">
                    <a href="javascript:void(0)" data-bind="click:$root.viewExamAnswer.bind($data,$root,$index())">预览</a>
