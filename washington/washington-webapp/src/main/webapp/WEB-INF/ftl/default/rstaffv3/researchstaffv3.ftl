    ...
    <#switch menuType>
        ...
        <div class="section">
            <div class="nav r-nav">
                <ul class="sn-list">
                <li class="si">
                    <#if currentUser.ktwelve == "PRIMARY_SCHOOL">
                        ...
                        <ul>
                            <#if currentUser.subject == "ENGLISH" && (currentUser.isResearchStaffForProvince() || currentUser.isResearchStaffForCounty() || currentUser.isResearchStaffForCity() || currentUser.isResearchStaffForStreet()) >
                                <li class="<#if menuIndex == 10>current</#if>">
                                    <a href="/rstaff/report/knowledgedata.vpage">
                                        知识数据
                                    </a>
                                </li>
                            </#if>
                            <li class="<#if menuIndex == 11>current</#if>">
                                <a href="/rstaff/report/behaviordata.vpage">
                                    行为数据
                                </a>
                            </li>
                            <#if currentUser.subject == "ENGLISH">
                                <li class="<#if menuIndex == 12>current</#if>">
                                    <a href="/rstaff/report/integralstat/summary.vpage">
                                        积分统计
                                    </a>
                                </li>
                            </#if>
                    ...
                    <#if (currentUser.isResearchStaffForCounty() || currentUser.isResearchStaffForCity()  || currentUser.isResearchStaffForStreet())>
                        <li class="si">
                            <a class="si-f" href="javascript:void(0);">组卷统考</a>
                            <ul>
                                <li class="<#if menuIndex == 22>current</#if>">
                                    <a href="/rstaff/oral/index.vpage">
                                        统考
                                    </a>
                                </li>
                            </ul>
                    ...
                    <#if currentUser.ktwelve == "PRIMARY_SCHOOL" && currentUser.subject == "ENGLISH">
                        <li class="si">
                            <a class="si-f" href="/tts/listening.vpage">
                                听力卷TTS
                            </a>
                        </li>
                    </#if>
