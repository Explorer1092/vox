        ...
        <div class="aDetails-section">
            ...
            <div class="r-inner">
                <div class="readTxt-list2">
                    <div class="frAside" data-bind="css:{'showDetails':$data.showDetail()},click:$root.showDetailBtn">
                ...
                <ul class="clearfix" data-bind="style:{width:$root.dubbingList().length * 192 + 'px'}"><!--width为li的个数*192px-->
                    ...
                    <li class="e-pictureList-2" data-bind="css:{'active' : package.stoneId == $root.focusPackage().stoneId},click:$root.oralItemClick.bind($data,$root,$index())">
                        ...
                        <div class="video-info">
                            ...
                            <#--<p class="text" data-bind="text:package.classLevelName">&nbsp;</p>-->
                            <p class="text" data-bind="text: package.sentences ? package.sentences.join(' / ') : ''">&nbsp;</p>
                        </div>
                    </li>
                    <!--/ko-->
                </ul>
                    ...
                    <li>
                        ...
                        <span class="accuracy">
                            ...
                            <div class="progressBar">
                                <div class="progressWri" data-bind="css:{'progressError' : proportion < 60},style:{width: (proportion + '%')}"></div>
                                <i data-bind="css:{'allCorrect' : proportion > 80}"><!--ko if:question.hasIntervention-->干预讲解后<!--/ko--><!--ko text:question.proportion--><!--/ko-->%</i>
                            </div>
                        </span>
...
<@sugar.capsule js=["ko",'homework2nd',"jplayer","homeworkv3.clazzreportdetail"] />
</@shell.page>