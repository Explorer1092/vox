<#--左侧二级tab-->
<script id="centerSecondTabTemp" type="text/html">
    <div class="second-tab-box JS-personCenterContent">
        <!-- ko foreach:centerSecTabList -->
        <div class="second-tab-content bg-active JS-secTabContent" data-bind="click: $root.changeTab.bind($data, $index())">
            <i class="icon"></i>
            <a href="javascript:void(0)" class="link"><span data-bind="text: $data"></span></a>
        </div>
        <!-- /ko-->
    </div>
</script>
...
<script id="teacherInfoTemp" type="text/html">
    ...
    <div class="class-module mt-20">
        <div class="module-head bg-f6 clearfix">
            ...
            <a href="javascript:void(0);" class="green_fontBtn fr" data-bind="click: $root.choiceSecondTabTemp.bind($data, 0)">修改资料 ></a>
        </div>
    ...
    <div class="class-module mt-20">
        <div class="module-head bg-f6 clearfix">
            ...
            <a href="javascript:void(0);" class="green_fontBtn fr" data-bind="click: $root.choiceSecondTabTemp.bind($data, 1)">修改设置 ></a>
        </div>
        <div class="personalData-box">
            <ul>
    ...
    <div class="class-module mt-20">
        ...
        <div class="personalData-list">
            <dl>
                ...
                <dt>联系电话：</dt>
                <dd>
                    <div class="telephone"><span data-bind="text: $root.mobile"></span>已经绑定手机号，<a class="to-change" href="javascript:void(0);" data-bind="click: $root.toChangeMobilePage.bind($data)">去更换</a></div>
                </dd>
                <#--<dt>配送方式：</dt>-->
                <#--<dd>-->
