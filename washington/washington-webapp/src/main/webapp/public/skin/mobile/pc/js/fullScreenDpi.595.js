var adaptUILayout = (function () {
    ...
    var adapt = function (uiWidth) {
        ...
        if (isiOS) {
            ...
            initialContent = 'target-densitydpi=device-dpi, width=' + ( deviceWidth >=768 ? 722 : 595 ) + ', user-scalable=no';
        } else {
            //use viewport Android device
            initialContent = 'target-densitydpi=' + targetDensityDpi + ', width=595, user-scalable=no';

            if (screen.width == "1080") {
                initialContent = 'target-densitydpi=320, width=595, user-scalable=no, minimum-scale=1.0, initial-scale=1.0, maximum-scale=1.0';
            }
            ...
            if(typeof $M === "function"){
                $M.appLog('homework',{
                    app: "17homework_my",
                    type: "log_normal",
                    module : "studentModuleTargetDpi",
                    operation : ("W:" + deviceWidth + "-H:" + deviceHeight + "-DPR:" + devicePixelRatio)
                });
            }
        }
