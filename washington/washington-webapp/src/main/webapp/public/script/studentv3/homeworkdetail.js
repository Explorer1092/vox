!function() {
    ...
    var TPL = {
        mainConent:['<div class="h-answerD-list">',
                        '<div id="subject_{qid}" class="hd"></div>',
                        '<div class="ft">',
                            '<ul class="ul-list-2">',
                            ...
                            loadExamImg : function(rootEleId,prefixElemId,examId,index){
                                ...
                                if(!$17.isBlank(examId)){
                                    ...
                                    vox.exam.render(node, 'normal', {
                                        ids       : [examId],
                                        imgDomain : detailDate.imgDomain,
                ...
                $.each(detailDate.questionInfoMapper[navName],function(){
                    if(this.fileType[0]=="IMAGE"){
                        ...
                        str += that.substitute(TPL.mainConent,{
                            qid:this.qid,
                            standardAnswers:this.standardAnswers,
                ...
                default:
                    ...
                    $.each(detailDate.questionInfoMapper[navName],function(){
                        ...
                        vox.exam.render(node, 'normal', {
                            ...
                            env       : answerDetailData.env,
                            domain    : answerDetailData.domain,
                            getQuestionsUrl:detailDate.questionUrl+navName,
                            getCompleteUrl:detailDate.completedUrl+navName
                        });
                    });
                    break;
            }
