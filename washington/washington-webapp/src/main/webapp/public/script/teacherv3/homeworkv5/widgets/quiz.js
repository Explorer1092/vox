!function($17,ko) {
    ...
    quiz.prototype = {
        ...
        showQuestions : function(content,index,isFirst){
            ...
            var self = this;
            this._fillFocusExamList(content[index].questions.slice(0,this.currentPageQuestionsCount),function(){
                self.packageInfo(ko.mapping.fromJS({
        ...
        _fillFocusExamList: function(questions,callback){
            ...
            $17.QuestionDB.getQuestionByIds(questionIds,function(result){
                ...
                self.currentPageQuestions(ko.mapping.fromJS(questions)());
        ...
        page_click : function(self,pageNo){
            ...
            self._fillFocusExamList(self.questions.slice(_startIndex,_startIndex+5));
        },
