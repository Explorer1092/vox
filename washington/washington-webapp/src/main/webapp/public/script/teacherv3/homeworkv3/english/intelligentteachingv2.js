...
(function($17,ko) {
    ...
    function IntelligentTeachingSmallPackage(params){
        ...
        this.questions = this.smallPackage ? this.smallPackage.questions : ko.observableArray([]);
        this.postQuestions = this.smallPackage ? this.smallPackage.postQuestions : ko.observableArray([]);
        this.loadExamImgFn = params.loadExamImg;
    ...
    IntelligentTeachingSmallPackage.prototype = {
        ...
        loadExamImg : function(examId,index,boxId){
            this.loadExamImgFn(examId,index,boxId);
            return "";
        },
