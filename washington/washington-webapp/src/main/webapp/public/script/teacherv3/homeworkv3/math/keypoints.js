    ...
    KeyPoints.prototype = {
        ...
        viewExamAnswer : function(self,index){
            var question = this
                ...
                ,renderQuestion = self.questionHandles[index] || {};
            if(renderQuestion && typeof renderQuestion.showAnalysis === 'function'){
                self.questionHandles[index].showAnalysis(_questionId);
            }
        },
        loadExamImg : function(examId,index){
            ...
            if(!$17.isBlank(examId) && constantObj.examInitComplete){
                ...
                self.questionHandles[index] = renderQuestion;
            }else{
