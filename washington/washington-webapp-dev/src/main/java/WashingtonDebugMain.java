...
public class WashingtonDebugMain {
    ...
    public static void main(String[] args) throws Exception {
         ...
         * spring CachedIntrospectionResult.<init>  2-3秒  主要用于bean的缓存，后续处理各种依赖之类的？
        ...
        ConfigService.initConfigService("washington", "dev", "dev", "10.200.3.54:8015");
        ...
        srv.start(HTTP_PORT, ClassPathUtils.getClassFileSystemPath(WashingtonDebugMain.class));
