...
/**
 * Created by Alex on 14-9-28.
 */
public class TestOpenApiEnglishQuestion {
    ...
    public static void main(String[] args) {
        try {
            ...
            final String practiceTypeList = "LISTEN_CHOOSE,PIC_CHOOSE,WORD_IDENTIFY,WORD_SPELL";

            // 计算SIG
            Map<String, String> paramMap = new HashMap<>();
            paramMap.put("app_key", appKey);
            paramMap.put("session_key", sessionKey);
            paramMap.put("practice_type_list", practiceTypeList);
            ...
            String apiURL = "http://api.17zuoye.com/v1/appquestion/english.vpage";
