 ...
 */
public class TestOpenApiUserAddIntegral {
    public static void main(String[] args) {
        try {
            System.out.println("Test Start...");

            final String appKey = "TravelAmerica";
            final String sessionKey = "42cca891bbe6e95baca645ce3397ad5c";
            final String integral = "5";
            ...
            String apiURL = "http://api.17zuoye.com/v1/user/integral/add.vpage";
