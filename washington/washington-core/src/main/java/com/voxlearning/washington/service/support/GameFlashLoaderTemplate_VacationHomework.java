...
/**
 * For loading vacation homework game flash.
 *
 * @author Xiaohai Zhang
 * @since 2013-06-08 14:21
 */
@Named
@Slf4j
@NoArgsConstructor
@IdentificationStudyType(StudyType.vacationHomework)
public class GameFlashLoaderTemplate_VacationHomework extends GameFlashLoaderTemplate {
    @Override
