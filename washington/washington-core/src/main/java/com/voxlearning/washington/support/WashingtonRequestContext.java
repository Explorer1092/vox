...
import com.voxlearning.washington.support.gray.StudentWebGrayFunction;
import com.voxlearning.washington.support.gray.TeacherWebGrayFunction;
 ...
 */
@Slf4j
public class WashingtonRequestContext extends UtopiaHttpRequestContext {
    ...
    @Setter private SensitiveUserDataServiceClient sensitiveUserDataServiceClient;
    ...
    public WashingtonRequestContext(HttpServletRequest request, HttpServletResponse response) {
...
//            case "currentUserProfileMobile":
//                return sensitiveUserDataServiceClient.loadUserMobileObscured(getUserId());
//            case "currentUserProfileEmail":
//                return sensitiveUserDataServiceClient.loadUserEmailObscured(getUserId());
//            case "currentUserProfileQq":
//                return sensitiveUserDataServiceClient.loadUserQqObscured(getUserId());
    ...
    public String getAuthenticatedOpenId() {
        return getCookieManager().getCookieDecrypt("T_openId", null);
    }

    public void setAuthenticatedOpenId(String openId, int expire) {
        getCookieManager().setCookieEncryptTLD("T_openId", openId, expire);
    }
}
