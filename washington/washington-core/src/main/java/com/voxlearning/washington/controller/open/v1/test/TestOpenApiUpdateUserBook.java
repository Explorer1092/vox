 ...
 */
public class TestOpenApiUpdateUserBook {
    public static void main(String[] args) {
        try {
            ...
            String sessionKey = "48991970fb538adc9df654ac1ba52470";
            String book_id = "100172";
            ...
            String apiURL = "http://localhost:8080/v1/user/selfstudy/book/update.vpage";
