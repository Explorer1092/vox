...
package com.voxlearning.washington.monitor;
...
import com.voxlearning.alps.spi.monitor.CountMonitorPoint;
import com.voxlearning.alps.spi.monitor.MonitorPointInfo;

@Install
@MBeanInfo(type = JmxType.monitor, name = "YZYTimeout")
@MonitorPointInfo(id = "YZYTimeout", measurement = "voice")
final public class YZYTimeout extends CountMonitorPoint {
}
