 ...
 */
public class TestTeacherHomework {
...
//            paramMap.put("homework_id", "54acae01de454cf6d8aec778");

//            paramMap.put("unit_id", "2187");
//            paramMap.put("clazz_id", "34149");
//            paramMap.put("subject", "ENGLISH");

            //MATH
            paramMap.put("unit_id", "2");
//            paramMap.put("clazz_id", "37051");
//            paramMap.put("subject", "MATH");
            ...
            String apiURL = "http://localhost:8080/v1/teacher/homework/manualselectmath.vpage";
