...
public class HomeWorkMapper implements Serializable {
    private static final long serialVersionUID = -9131188443913095136L;

    private String classId;
    private String startTime;
    private String endTime;
    private String normFinishTime;
    private List<BookMapper> homework;
    private String homeWorkJson;
    private String homeWorkId;
    private String clazzIds;
    private String homeworkTime;
    private List<PaperMapper> paper;
