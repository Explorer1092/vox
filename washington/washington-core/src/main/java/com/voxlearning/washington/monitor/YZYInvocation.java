...
@Install
@MBeanInfo(type = JmxType.monitor, name = "YZYInvocation")
@MonitorPointInfo(id = "YZYInvocation", measurement = "voice")
final public class YZYInvocation extends InvocationMonitorPoint {
}
