 ...
 */
public class TestOpenApiGetForgotPasswordVerifyCode {
    public static void main(String[] args) {
        try {
            System.out.println("Test Start...");

            final String appKey = "StudyCraft";
            final String secretKey = "8Un3gjOH67nY";
            ...
            String apiURL = "http://www.testing.17zuoye.net/v1/user/forgotpassword/verifycode/get.vpage";
