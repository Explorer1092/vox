 ...
 */
public class TestOpenApiGetUserBooks {
    public static void main(String[] args) {
        try {
            ...
            String sessionKey = "19cf0bc141890bae548a84383acad8bf";
            String clazzLevel = "1";
            ...
            String apiURL = "http://www.test.17zuoye.net/v1/user/selfstudy/books.vpage";
